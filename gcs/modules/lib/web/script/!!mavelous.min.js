...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};var GCSDjimMolenkamp={util:{}};GCSDjimMolenkamp.util.heartbeat={};GCSDjimMolenkamp.util.MavModeFlag={CUSTOM_MODE_ENABLED:1,TEST_ENABLED:2,AUTO_ENABLED:4,GUIDED_ENABLED:8,STABILIZE_ENABLED:16,HIL_ENABLED:32,MANUAL_INPUT_ENABLED:64,SAFETY_ARMED:128};GCSDjimMolenkamp.util.MavType={FIXED_WING:1,QUADROTOR:2};GCSDjimMolenkamp.util.ArduPlaneFlightModes={0:"MANUAL",1:"CIRCLE",2:"STABILIZE",5:"FBWA",6:"FBWB",7:"FBWC",10:"AUTO",11:"RTL",12:"LOITER",13:"TAKEOFF",14:"LAND",15:"GUIDED",16:"INITIALIZING"};
GCSDjimMolenkamp.util.ArduCopterFlightModes={0:"STABILIZE",1:"ACRO",2:"ALT_HOLD",3:"AUTO",4:"GUIDED",5:"LOITER",6:"RTL",7:"CIRCLE",8:"POSITION",9:"LAND",10:"OF_LOITER",11:"APPROACH"};GCSDjimMolenkamp.util.heartbeat.mavtype=function(a){a=a.get("type");return a==GCSDjimMolenkamp.util.MavType.QUADROTOR?"ArduCopter":a==GCSDjimMolenkamp.util.MavType.FIXED_WING?"ArduPlane":"unknown"};
GCSDjimMolenkamp.util.heartbeat.modestring=function(a){var b=a.get("base_mode"),c=a.get("type");a=a.get("custom_mode");return null===b||null===c||null===a?"badmode":!b&GCSDjimMolenkamp.util.MavModeFlag.CUSTOM_MODE_ENABLED?"BaseMode("+b+")":c==GCSDjimMolenkamp.util.MavType.QUADROTOR&&goog.object.containsKey(GCSDjimMolenkamp.util.ArduCopterFlightModes,a)?GCSDjimMolenkamp.util.ArduCopterFlightModes[a]:c==GCSDjimMolenkamp.util.MavType.FIXED_WING&&goog.object.containsKey(GCSDjimMolenkamp.util.ArduPlaneFlightModes,a)?GCSDjimMolenkamp.util.ArduPlaneFlightModes[a]:"CustomMode("+
a+")"};GCSDjimMolenkamp.util.heartbeat.armed=function(a){a=a.get("base_mode");return null===a?null:a&GCSDjimMolenkamp.util.MavModeFlag.SAFETY_ARMED?!0:!1};GCSDjimMolenkamp.ModeStringView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.ModeStringView,Backbone.View);GCSDjimMolenkamp.ModeStringView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=this.options.el;this.heartbeat=a.subscribe("HEARTBEAT",this.onHeartbeat,this)};goog.exportSymbol("GCSDjimMolenkamp.ModeStringView.prototype.initialize",GCSDjimMolenkamp.ModeStringView.prototype.initialize);
GCSDjimMolenkamp.ModeStringView.prototype.onHeartbeat=function(){var a=GCSDjimMolenkamp.util.heartbeat.modestring(this.heartbeat),b=GCSDjimMolenkamp.util.heartbeat.armed(this.heartbeat);a&&this.$el.html(b?a+' <span class="ok">ARMED</span>':a+' <span class="slow">DISARMED</span>')};GCSDjimMolenkamp.StatustextView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.StatustextView,Backbone.View);GCSDjimMolenkamp.StatustextView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=$("#statustextview");this.statusText=a.subscribe("STATUSTEXT",this.onStatusTextChange,this);this.onStatusTextChange()};goog.exportSymbol("GCSDjimMolenkamp.StatustextView.prototype.initialize",GCSDjimMolenkamp.StatustextView.prototype.initialize);
GCSDjimMolenkamp.StatustextView.prototype.onStatusTextChange=function(){clearTimeout(this.timeout);var a=this.$el;a.html(this.statusText.get("text"));a.css("padding",10);this.timeout=setTimeout(function(){a.html("");a.css("padding",0)},4E3)};GCSDjimMolenkamp.GpsTextView={};GCSDjimMolenkamp.GpsButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.GpsButtonView,Backbone.View);GCSDjimMolenkamp.GpsButtonView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.renderTemplate_();this.gps=a.subscribe("GPS_RAW_INT",this.onGPS_,this)};goog.exportSymbol("GCSDjimMolenkamp.GpsButtonView.prototype.initialize",GCSDjimMolenkamp.GpsButtonView.prototype.initialize);
GCSDjimMolenkamp.GpsButtonView.prototype.renderTemplate_=function(){var a;a='<span class="hidden-phone">GPS: <span id="gps-btn-lock-status"></span>';a+="</span>";a+='<i class="icon-globe icon-white visible-phone"></i>';this.$el.html(a);this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");this.$el.addClass("btn-inverse")};
GCSDjimMolenkamp.GpsButtonView.prototype.renderFixType_=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");var b="btn-inverse",c="None";3<=a?(b="btn-success",c="3D"):2==a?(b="btn-warning",c="2D"):1==a&&(b="btn-danger",c="No Lock");this.$el.addClass(b);this.$el.find("#gps-btn-lock-status").text(c)};GCSDjimMolenkamp.GpsButtonView.prototype.onGPS_=function(){var a=this.gps.get("fix_type");this.renderFixType_(a)};GCSDjimMolenkamp.GpsPopoverViewDelegate=function(a){this.popoverTitle="GPS Info";Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.GpsPopoverViewDelegate,Backbone.View);GCSDjimMolenkamp.GpsPopoverViewDelegate.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.gps=a.subscribe("GPS_RAW_INT",this.render,this);this.stat=a.subscribe("GPS_STATUS",this.render,this)};GCSDjimMolenkamp.GpsPopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.render()};
GCSDjimMolenkamp.GpsPopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null};
GCSDjimMolenkamp.GpsPopoverViewDelegate.prototype.render=function(){if(this.$el){var a=this.stat.toJSON(),b=(this.gps.get("lat")/1E7).toFixed(7),c=(this.gps.get("lon")/1E7).toFixed(7),d="";"satellites_visible"in a&&(d+="Satellites: "+a.satellites_visible.toString()+"<br /> Coordinates: "+b+", "+c);a=this.gps.get("eph");"undefined"!=typeof a&&65535!=a&&(d+="<br />HDOP: "+(a/100).toFixed(2)+"m");a=this.gps.get("epv");"undefined"!=typeof a&&65535!=a&&(d+="<br />VDOP: "+(a/100).toFixed(2)+"m");this.$el.find(".popover-content").html(d)}};GCSDjimMolenkamp.SelectionModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.SelectionModel,Backbone.Model);GCSDjimMolenkamp.SelectionModel.prototype.defaults=function(){return{selected:!1}};goog.exportSymbol("GCSDjimMolenkamp.SelectionModel.prototype.defaults",GCSDjimMolenkamp.SelectionModel.prototype.defaults);
GCSDjimMolenkamp.PopoverView=function(a){this.template='<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>';Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.PopoverView,Backbone.View);
GCSDjimMolenkamp.PopoverView.prototype.initialize=function(){this.$el=null;this.btn=this.options.btn;this.placement=this.options.placement||"bottom";this.delegate=this.options.delegate;this.selectionModel=new GCSDjimMolenkamp.SelectionModel;this.radioBtnController=this.options.radioBtnController;this.selectionModel.bind("change",this.onSelectionChange_,this);this.btn.$el.click(goog.bind(this.radioBtnController.onButtonClick,this.radioBtnController,this))};
goog.exportSymbol("GCSDjimMolenkamp.PopoverView.prototype.initialize",GCSDjimMolenkamp.PopoverView.prototype.initialize);GCSDjimMolenkamp.PopoverView.prototype.select=function(){this.selectionModel.set("selected",!0)};GCSDjimMolenkamp.PopoverView.prototype.deselect=function(){this.selectionModel.set("selected",!1)};GCSDjimMolenkamp.PopoverView.prototype.selected=function(){return this.selectionModel.get("selected")};
GCSDjimMolenkamp.PopoverView.prototype.onSelectionChange_=function(){if(this.selectionModel.get("selected")){this.createElement();var a=this.$el.find(".popover-inner");this.delegate.popoverCreated(a)}else this.delegate.popoverDestroyed(),this.destroyElement()};GCSDjimMolenkamp.PopoverView.prototype.createElement=function(){this.$el=$(this.template);this.$el.removeClass("fade top bottom left right in");this.$el.remove().css({top:0,left:0,display:"block"}).appendTo(document.body);this.$el.css(this.placementStyle(this.placement)).addClass(this.placement).addClass("in")};
GCSDjimMolenkamp.PopoverView.prototype.placementStyle=function(a){var b=$.extend({},this.btn.$el.offset(),{width:this.btn.$el[0].offsetWidth,height:this.btn.$el[0].offsetHeight}),c=this.$el[0].offsetWidth,d=this.$el[0].offsetHeight;switch(a){case "bottom":return{top:b.top+b.height,left:b.left+b.width/2-c/2};case "top":return{top:b.top-d,left:b.left+b.width/2-c/2};case "left":return{top:b.top+b.height/2-d/2,left:b.left-c};case "right":return{top:b.top+b.height/2-d/2,left:b.left+b.width}}};
GCSDjimMolenkamp.PopoverView.prototype.destroyElement=function(){this.$el&&this.$el.remove()};GCSDjimMolenkamp.BatteryButton=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.BatteryButton,Backbone.View);GCSDjimMolenkamp.BatteryButton.prototype.initialize=function(){this.sysstatus=this.options.mavlinkSrc.subscribe("SYS_STATUS",this.onSysStatus,this);this.$el=this.options.el};goog.exportSymbol("GCSDjimMolenkamp.BatteryButton.prototype.initialize",GCSDjimMolenkamp.BatteryButton.prototype.initialize);
GCSDjimMolenkamp.BatteryButton.prototype.onSysStatus=function(){var a=this.sysstatus,b=a.get("battery_remaining"),a=a.get("voltage_battery");30>b?this.setButton_("btn-warning",b.toFixed(0)+"%"):20>b?this.setButton_("btn-danger",b.toFixed(0)+"% "+a.toFixed(1)+"v"):void 0===b?this.setButton_("btn-inverse","Unknown"):this.setButton_("btn-success",b.toFixed(0)+"%")};
GCSDjimMolenkamp.BatteryButton.prototype.setButton_=function(a,b){this.$el.removeClass("btn-success btn-warning btn-danger btn-inverse");this.$el.addClass(a);var c;c='<span class="hidden-phone">Batt: '+b+'</span><i class="icon-fire icon-white visible-phone"></i>';this.$el.html(c)};GCSDjimMolenkamp.LeafletPanControlView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.LeafletPanControlView,Backbone.View);GCSDjimMolenkamp.LeafletPanControlView.prototype.initialize=function(){this.button=this.options.button;this.icon=this.options.icon;this.button.click(goog.bind(this.onClick,this));this.model.on("change:tracking",this.onTrackingChange,this);this.onTrackingChange()};goog.exportSymbol("GCSDjimMolenkamp.LeafletPanControlView.prototype.initialize",GCSDjimMolenkamp.LeafletPanControlView.prototype.initialize);
GCSDjimMolenkamp.LeafletPanControlView.prototype.onClick=function(){this.model.get("tracking")?this.model.set("tracking",!1):this.model.set("tracking",!0)};GCSDjimMolenkamp.LeafletPanControlView.prototype.onTrackingChange=function(){this.model.get("tracking")?(this.button.addClass("btn-primary"),this.icon.removeClass("icon-black"),this.icon.addClass("icon-white")):(this.button.removeClass("btn-primary"),this.icon.removeClass("icon-white"),this.icon.addClass("icon-black"))};
GCSDjimMolenkamp.LeafletPanModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.LeafletPanModel,Backbone.Model);GCSDjimMolenkamp.LeafletPanModel.prototype.defaults=function(){return{initialized:!1,tracking:!0,center:void 0}};goog.exportSymbol("GCSDjimMolenkamp.LeafletPanModel.prototype.defaults",GCSDjimMolenkamp.LeafletPanModel.prototype.defaults);GCSDjimMolenkamp.LeafletPanModel.prototype.initialize=function(){this.vehicle=this.get("vehicle");this.vehicle.on("change",this.onVehicleChange_,this)};
goog.exportSymbol("GCSDjimMolenkamp.LeafletPanModel.prototype.initialize",GCSDjimMolenkamp.LeafletPanModel.prototype.initialize);GCSDjimMolenkamp.LeafletPanModel.prototype.onVehicleChange_=function(){var a=this.vehicle.get("position");this.get("initialized")?this.get("tracking")&&a&&(a.lat&&a.lng)&&this.set({center:a}):a&&(a.lat&&a.lng)&&this.set({center:a,initialized:!0})};GCSDjimMolenkamp.LeafletPanModel.prototype.cancelTracking=function(){this.set("tracking",!1)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(this.creationStack=Error().stack,goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.instances_={};goog.Disposable.getUndisposedObjects=function(){var a=[],b;for(b in goog.Disposable.instances_)goog.Disposable.instances_.hasOwnProperty(b)&&a.push(goog.Disposable.instances_[Number(b)]);return a};
...
goog.async.Throttle.prototype.disposeInternal=function(){goog.async.Throttle.superClass_.disposeInternal.call(this);this.stop()};goog.async.Throttle.prototype.onTimer_=function(){this.timer_=null;this.shouldFire_&&!this.pauseCount_&&(this.shouldFire_=!1,this.doAction_())};goog.async.Throttle.prototype.doAction_=function(){this.timer_=goog.Timer.callOnce(this.callback_,this.interval_);this.listener_.call(this.handler_)};GCSDjimMolenkamp.CommStatusModel=function(a){this.SERVER_TIMEOUT_INTERVAL=3E3;this.HEARTBEAT_TIMEOUT_INTERVAL=2E3;Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.CommStatusModel,Backbone.Model);GCSDjimMolenkamp.CommStatusModel.State={UNINITIALIZED:0,OK:1,TIMED_OUT_ONCE:2,TIMED_OUT_MANY:3,ERROR:4};GCSDjimMolenkamp.CommStatusModel.prototype.defaults=function(){return{mav:GCSDjimMolenkamp.CommStatusModel.State.UNINITIALIZED,server:GCSDjimMolenkamp.CommStatusModel.State.UNINITIALIZED}};
goog.exportSymbol("GCSDjimMolenkamp.CommStatusModel.prototype.defaults",GCSDjimMolenkamp.CommStatusModel.prototype.defaults);GCSDjimMolenkamp.CommStatusModel.prototype.initialize=function(){var a=this.get("mavlinkSrc");a.subscribe("HEARTBEAT",this.onHeartbeat,this);a.on("gotServerResponse",this.onServerSuccess,this);a.on("gotServerError",this.onServerError,this);this.resetServerTimeout()};goog.exportSymbol("GCSDjimMolenkamp.CommStatusModel.prototype.initialize",GCSDjimMolenkamp.CommStatusModel.prototype.initialize);
GCSDjimMolenkamp.CommStatusModel.prototype.onHeartbeat=function(){this.set("mav",GCSDjimMolenkamp.CommStatusModel.State.OK);this.resetHeartbeatTimeout()};GCSDjimMolenkamp.CommStatusModel.prototype.resetHeartbeatTimeout=function(){var a=this;clearTimeout(this.heartbeatTimeout);this.heartbeatTimeout=setTimeout(function(){a.onHeartbeatTimeout()},this.HEARTBEAT_TIMEOUT_INTERVAL)};
GCSDjimMolenkamp.CommStatusModel.prototype.onHeartbeatTimeout=function(){var a=this.get("mav");a===GCSDjimMolenkamp.CommStatusModel.State.OK?this.set("mav",GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE):a===GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("mav",GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_MANY);this.resetHeartbeatTimeout()};GCSDjimMolenkamp.CommStatusModel.prototype.onServerSuccess=function(){this.set("server",GCSDjimMolenkamp.CommStatusModel.State.OK);this.resetServerTimeout()};
GCSDjimMolenkamp.CommStatusModel.prototype.onServerError=function(){this.set("server",GCSDjimMolenkamp.CommStatusModel.State.ERROR)};GCSDjimMolenkamp.CommStatusModel.prototype.resetServerTimeout=function(){var a=this;clearTimeout(this.serverTimeout);this.serverTimeout=setTimeout(function(){a.onServerTimeout()},this.SERVER_TIMEOUT_INTERVAL)};
GCSDjimMolenkamp.CommStatusModel.prototype.onServerTimeout=function(){var a=this.get("server");a===GCSDjimMolenkamp.CommStatusModel.State.OK?this.set("server",GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE):a===GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("server",GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_MANY);this.resetServerTimeout()};GCSDjimMolenkamp.PacketLossModel=function(a){this.period=10;Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.PacketLossModel,Backbone.Model);
GCSDjimMolenkamp.PacketLossModel.prototype.defaults=function(){return{history:[],current:-1}};goog.exportSymbol("GCSDjimMolenkamp.PacketLossModel.prototype.defaults",GCSDjimMolenkamp.PacketLossModel.prototype.defaults);GCSDjimMolenkamp.PacketLossModel.prototype.initialize=function(){this.metalinkquality=this.get("mavlinkSrc").subscribe("META_LINKQUALITY",this.onMessage,this)};goog.exportSymbol("GCSDjimMolenkamp.PacketLossModel.prototype.initialize",GCSDjimMolenkamp.PacketLossModel.prototype.initialize);
GCSDjimMolenkamp.PacketLossModel.prototype.onMessage=function(){var a=this.get("history"),b=this.get("current"),c=this.metalinkquality.toJSON(),b=(b+1)%(this.period+1);a[b]=c;this.set("history",a);this.set("current",b)};GCSDjimMolenkamp.PacketLossModel.prototype.getDelta=function(){var a=this.get("history"),b=this.get("current");if(0>b)return null;var c=a[(b+1)%(this.period+1)];return c?this.diff(a[b],c,this.period):this.diff(a[b],a[0],b)};
GCSDjimMolenkamp.PacketLossModel.prototype.diff=function(a,b,c){return{master_in:a.master_in-b.master_in,master_out:a.master_out-b.master_out,mav_loss:a.mav_loss-b.mav_loss,period:c}};GCSDjimMolenkamp.CommStatusButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.CommStatusButtonView,Backbone.View);GCSDjimMolenkamp.CommStatusButtonView.prototype.initialize=function(){this.commStatusModel=this.options.commStatusModel;this.commStatusModel.bind("change",this.buttonRender,this)};
goog.exportSymbol("GCSDjimMolenkamp.CommStatusButtonView.prototype.initialize",GCSDjimMolenkamp.CommStatusButtonView.prototype.initialize);
GCSDjimMolenkamp.CommStatusButtonView.prototype.buttonRender=function(){var a=this.commStatusModel.toJSON(),b=a.server,a=a.mav,c=GCSDjimMolenkamp.CommStatusModel.State.UNINITIALIZED,d=GCSDjimMolenkamp.CommStatusModel.State.OK,e=GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE,f=GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_MANY,g=GCSDjimMolenkamp.CommStatusModel.State.ERROR;b===d&&a===d?this.setButton(d):b===c||a===c?this.setButton(c):b===f||a===f?this.setButton(f):b===e||a===e?this.setButton(e):b===g||a===g?this.setButton(g):goog.asserts.assert(!1,
"Unknown comm status: "+b+"/"+a)};
GCSDjimMolenkamp.CommStatusButtonView.prototype.setButton=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse ");var b="Link: None",c="btn-inverse";a===GCSDjimMolenkamp.CommStatusModel.State.UNINITIALIZED?(c="btn-inverse",b="Link: None"):a===GCSDjimMolenkamp.CommStatusModel.State.OK?(c="btn-success",b="Link: Good"):a===GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_ONCE?(c="btn-warning",b="Link: Lost"):a===GCSDjimMolenkamp.CommStatusModel.State.TIMED_OUT_MANY?(c="btn-danger",b="Link: Lost"):(c="btn-danger",
...
goog.net.jsloader.Error=function(a,b){var c="Jsloader error (code #"+a+")";b&&(c+=": "+b);goog.debug.Error.call(this,c);this.code=a};goog.inherits(goog.net.jsloader.Error,goog.debug.Error);GCSDjimMolenkamp.LeafletDroneIconModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.LeafletDroneIconModel,Backbone.Model);GCSDjimMolenkamp.LeafletDroneIconModel.prototype.defaults=function(){return{icon:"predatorsmall"}};goog.exportSymbol("GCSDjimMolenkamp.LeafletDroneIconModel.prototype.defaults",GCSDjimMolenkamp.LeafletDroneIconModel.prototype.defaults);GCSDjimMolenkamp.LeafletDroneIconModel.prototype.getIcon=function(){var a=this.get("icon");return new GCSDjimMolenkamp.LeafletDroneIconModel.Icons[a].constructor};
GCSDjimMolenkamp.LeafletDroneIconModel.Icons={predatorsmall:{description:"Predator (small)",constructor:L.Icon.extend({options:{iconUrl:"image/drone-tiny.png",shadowUrl:null,iconAnchor:new L.Point(37,25),iconSize:new L.Point(75,50)}})},predator:{description:"Predator",constructor:L.Icon.extend({options:{iconUrl:"image/drone-sm.png",shadowUrl:null,iconAnchor:new L.Point(75,50),iconSize:new L.Point(150,100)}})},arduplane:{description:"Generic Airplane",constructor:L.Icon.extend({options:{iconUrl:"image/plane.png",
shadowUrl:null,iconAnchor:new L.Point(36,38),iconSize:new L.Point(73,76)}})},quad:{description:"Quadcopter",constructor:L.Icon.extend({options:{iconUrl:"image/quad.png",shadowUrl:null,iconAnchor:new L.Point(37,37),iconSize:new L.Point(75,75)}})}};GCSDjimMolenkamp.FlightModePopoverViewDelegate=function(a){this.popoverTitle="Flight Commands";Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.FlightModePopoverViewDelegate,Backbone.View);GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.commandModel=this.options.commandModel};goog.exportSymbol("GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.initialize",GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.initialize);
GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.setupPopover()};GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null;this.cleanupSubview("armingButtonView");this.cleanupSubview("loiterButtonView");this.cleanupSubview("rtlButtonView");this.cleanupSubview("landButtonView")};
GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.setupPopover=function(){this.$el.find(".popover-content").html('<p><a class="btn" id="flightmode-btn-arm" href="#">Arm</a></p><br /><a class="btn" id="flightmode-btn-loiter" href="#">Loiter</a><a class="btn" id="flightmode-btn-rtl" href="#">RTL</a><a class="btn" id="flightmode-btn-land" href="#">Land</a>');this.armingButtonView=new GCSDjimMolenkamp.ArmingButtonView({el:$("#flightmode-btn-arm"),model:this.modeModel});this.loiterButtonView=new GCSDjimMolenkamp.CommandButtonView({el:$("#flightmode-btn-loiter"),
model:this.commandModel,command:"NAV_LOITER_UNLIM"});this.rtlButtonView=new GCSDjimMolenkamp.CommandButtonView({el:$("#flightmode-btn-rtl"),model:this.commandModel,command:"NAV_RETURN_TO_LAUNCH"});this.landButtonView=new GCSDjimMolenkamp.CommandButtonView({el:$("#flightmode-btn-land"),model:this.commandModel,command:"NAV_LAND"})};GCSDjimMolenkamp.FlightModePopoverViewDelegate.prototype.cleanupSubview=function(a){this[a]&&(this[a].remove(),this[a]=null)};GCSDjimMolenkamp.AppRouter=function(a){this.pfdSettingsModel=a.pfdSettingsModel;this.routes={overview:"route_overview",fullpfd:"route_fullpfd",maponly:"route_maponly"};Backbone.Router.call(this,a)};goog.inherits(GCSDjimMolenkamp.AppRouter,Backbone.Router);GCSDjimMolenkamp.AppRouter.prototype.initialize=function(a){var b={};_.each(this.routes,function(a,d){var e=$("#navbar-"+d);0<e.length&&(b[d]=e)});this.navbar=b};goog.exportSymbol("GCSDjimMolenkamp.AppRouter.prototype.initialize",GCSDjimMolenkamp.AppRouter.prototype.initialize);
GCSDjimMolenkamp.AppRouter.prototype.route_overview=function(){this.setnavbar("overview");this.pfdSettingsModel.set({size:GCSDjimMolenkamp.PFDSettingsModel.Size.STANDARD})};goog.exportSymbol("GCSDjimMolenkamp.AppRouter.prototype.route_overview",GCSDjimMolenkamp.AppRouter.prototype.route_overview);GCSDjimMolenkamp.AppRouter.prototype.route_fullpfd=function(){this.setnavbar("fullpfd");this.pfdSettingsModel.set({size:GCSDjimMolenkamp.PFDSettingsModel.Size.FULLSCREEN})};goog.exportSymbol("GCSDjimMolenkamp.AppRouter.prototype.route_fullpfd",GCSDjimMolenkamp.AppRouter.prototype.route_fullpfd);
GCSDjimMolenkamp.AppRouter.prototype.route_maponly=function(){this.setnavbar("maponly");this.pfdSettingsModel.set({size:GCSDjimMolenkamp.PFDSettingsModel.Size.HIDDEN})};goog.exportSymbol("GCSDjimMolenkamp.AppRouter.prototype.route_maponly",GCSDjimMolenkamp.AppRouter.prototype.route_maponly);GCSDjimMolenkamp.AppRouter.prototype.setnavbar=function(a){_.each(this.navbar,function(a){a.removeClass("active")});this.navbar[a].addClass("active")};GCSDjimMolenkamp.ArtificialHorizon=function(a){this.initArtificialHorizon_(a);Kinetic.Shape.call(this,a)};goog.inherits(GCSDjimMolenkamp.ArtificialHorizon,Kinetic.Shape);GCSDjimMolenkamp.ArtificialHorizon.prototype.initArtificialHorizon_=function(a){Kinetic.Shape.call(this,a);this.setAttrs({width:100,height:100,skyColor:"#72cde4",groundColor:"#323232",lineColor:"#ffffff",planeColor:"black"});this.shapeType="ArtificialHorizon";this.radius=Math.min(a.width,a.height)/2;this.roll=this.pitch=0;this._setDrawFuncs()};
GCSDjimMolenkamp.ArtificialHorizon.prototype.drawFunc=function(a){a=a.getContext();var b=this.getHorizon_(this.pitch),c=this.getAttrs(),d=c.width,e=c.height;a.translate(d/2,e/2);a.save();a.beginPath();a.rect(-d/2,-e/2,d,e);a.clip();a.rotate(-this.roll);a.fillStyle=c.groundColor;a.strokeStyle=c.lineColor;a.lineWidth=3;a.beginPath();a.rect(-d,b,2*d,e);a.fill();a.fillStyle=c.skyColor;a.beginPath();a.rect(-d,-e,2*d,e+b);a.fill();a.lineWidth=1;a.beginPath();a.moveTo(-d/2,b);a.lineTo(d/2,b);a.stroke();this.drawPitchRung_(a,
...
-1);a.lineTo(10,-1);a.lineTo(5,5);a.stroke()};goog.exportSymbol("GCSDjimMolenkamp.ArtificialHorizon.prototype.drawFunc",GCSDjimMolenkamp.ArtificialHorizon.prototype.drawFunc);
GCSDjimMolenkamp.ArtificialHorizon.prototype.drawTriangle_=function(a,b,c,d,e){Math.cos(b);Math.sin(b);var f=2*Math.PI/180,g=this.getAttrs();a.lineWidth=1;a.strokeStyle=g.lineColor;a.beginPath();a.moveTo(d*Math.cos(b),d*Math.sin(b));a.lineTo((d+c)*Math.cos(b+f),(d+c)*Math.sin(b+f));a.lineTo((d+c)*Math.cos(b-f),(d+c)*Math.sin(b-f));a.lineTo(d*Math.cos(b),d*Math.sin(b));a.stroke();e&&(a.fillStyle=g.lineColor,a.fill())};
GCSDjimMolenkamp.ArtificialHorizon.prototype.drawRollRung_=function(a,b,c,d){var e=Math.cos(b);b=Math.sin(b);var f=this.getAttrs();a.lineWidth=1;a.strokeStyle=f.lineColor;a.beginPath();a.moveTo(e*d,b*d);a.lineTo(e*(d+c),b*(d+c));a.stroke()};
GCSDjimMolenkamp.ArtificialHorizon.prototype.drawPitchRung_=function(a,b,c){var d=this.getAttrs();a.lineWidth=1;a.strokeStyle=d.lineColor;d=this.getHorizon_(this.pitch+b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke();d=this.getHorizon_(this.pitch-b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke()};GCSDjimMolenkamp.ArtificialHorizon.prototype.getHorizon_=function(a){return Math.sin(a)*this.radius};
GCSDjimMolenkamp.ArtificialHorizon.prototype.setPitchRoll=function(a,b){this.pitch=a;this.roll=b};GCSDjimMolenkamp.Tape=function(a){Kinetic.Shape.call(this,a);this.initTape_(a)};goog.inherits(GCSDjimMolenkamp.Tape,Kinetic.Shape);GCSDjimMolenkamp.Tape.WIDTH=30;GCSDjimMolenkamp.Tape.HEIGHT=140;
GCSDjimMolenkamp.Tape.prototype.initTape_=function(a){var b=GCSDjimMolenkamp.Tape.WIDTH,c=GCSDjimMolenkamp.Tape.HEIGHT;this.setAttrs({backgroundColor:void 0,width:b,height:c,fontFamily:"Calibri",fontSize:12,fontStyle:"normal",side:GCSDjimMolenkamp.Tape.SideType.LEFT});this.value=0;this.targetValue=null;this.valueText="0";Kinetic.Shape.call(this,a);this._setDrawFuncs();this.instantaneousPolygon=new Kinetic.Polygon({points:this.reflect_([0,60*c/140,25*b/30,60*c/140,b,c/2,25*b/30,80*c/140,0,80*c/140,0,60*c/140]),stroke:a.fontColor,
strokeWidth:1,fill:a.instantaneousBackgroundColor});this.bug=new Kinetic.Polygon({x:0,y:0,points:this.reflect_([31*b/30,0,34*b/30,-2*c/140,36*b/30,-2*c/140,36*b/30,2*c/140,34*b/30,2*c/140,31*b/30,0]),stroke:a.bugColor,fill:a.bugColor,strokeWidth:1})};GCSDjimMolenkamp.Tape.prototype.reflect1_=function(a){var b=this.getAttrs();return b.side===GCSDjimMolenkamp.Tape.SideType.RIGHT?b.width-a:a};
GCSDjimMolenkamp.Tape.prototype.reflect_=function(a){var b=this.getAttrs();if(b.side===GCSDjimMolenkamp.Tape.SideType.RIGHT)for(var b=b.width,c=a.length,d=0;d<c;d+=2)a[d]=b-a[d];return a};GCSDjimMolenkamp.Tape.prototype.setValue=function(a){if(a!=this.value){this.value=a;var b="ERR";goog.isDefAndNotNull(a)&&(b=a.toString());3<b.length&&(b=b.substring(0,3),"."==b.charAt(b.length-1)&&(b=b.substr(0,b.length-1)));this.valueText=b}};GCSDjimMolenkamp.Tape.prototype.setTargetValue=function(a){this.targetValue=a};
GCSDjimMolenkamp.Tape.prototype.drawFunc=function(a){var b=a.getContext(),c=GCSDjimMolenkamp.Tape.WIDTH,d=GCSDjimMolenkamp.Tape.HEIGHT,e=this.getAttrs();goog.isDefAndNotNull(e.backgroundColor)&&(b.beginPath(),b.fillStyle=e.backgroundColor,b.rect(0,0,30,140),b.closePath(),this.fillStroke(b));var f=this.value-d/4,f=2*Math.ceil(f/2),f=Math.max(0,f),g=this.value+d/4,g=2*Math.floor(g/2),h="normal "+0.9*e.fontSize+"pt "+e.fontFamily;b.font=h;b.fillStyle=e.fontColor;b.strokeStyle=e.fontColor;b.textBaseLine="top";b.textAlign=e.side===
...
new Kinetic.Text({x:0,y:5,width:30,align:"center",fontSize:c,fontFamily:this.options.fontFamily,textFill:this.options.bugColor});this.layer.add(this.targetSpeedDisplay)};GCSDjimMolenkamp.PFD.prototype.setSize=function(a,b){var c,d=0;a/b>4/3?(c=4/3*b,d=b):(c=a,d=0.75*a);this.stage.setSize(c,d);this.stage.setScale(c/200,c/200)};GCSDjimMolenkamp.PFD.prototype.setSpeed=function(a){this.speedTape.setValue(a)};
GCSDjimMolenkamp.PFD.prototype.setTargetSpeed=function(a){this.targetSpeed=a;null===a?(this.speedTape.setTargetValue(null),this.targetSpeedDisplay.hide()):(this.speedTape.setTargetValue(a),this.targetSpeedDisplay.setText(Math.round(a).toString()),this.targetSpeedDisplay.show())};GCSDjimMolenkamp.PFD.prototype.draw=function(){this.visible&&this.layer.draw()};GCSDjimMolenkamp.PFD.prototype.setVisible=function(a){this.visible=a};GCSDjimMolenkamp.PFD.prototype.setAltitude=function(a){this.altitudeTape.setValue(a)};
GCSDjimMolenkamp.PFD.prototype.setTargetAltitude=function(a){this.targetAltitude=a;null===a?(this.altitudeTape.setTargetValue(null),this.targetAltitudeDisplay.hide()):(this.altitudeTape.setTargetValue(a),this.targetAltitudeDisplay.setText(Math.round(a).toString()),this.targetAltitudeDisplay.show())};GCSDjimMolenkamp.PFD.setHeading=function(a){};GCSDjimMolenkamp.PFD.prototype.setAttitude=function(a,b){this.attitudeIndicator.setPitchRoll(a,b)};goog.json={};goog.json.isValid_=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};goog.json.parse=function(a){a=String(a);if(goog.json.isValid_(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};goog.json.unsafeParse=function(a){return eval("("+a+")")};
...
goog.json.Serializer.prototype.serializeObject_=function(a,b){b.push("{");var c="",d;for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var e=a[d];"function"!=typeof e&&(b.push(c),this.serializeString_(d,b),b.push(":"),this.serialize_(this.replacer_?this.replacer_.call(a,d,e):e,b),c=",")}b.push("}")};GCSDjimMolenkamp.PFDSettingsModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.PFDSettingsModel,Backbone.Model);GCSDjimMolenkamp.PFDSettingsModel.Position={TOPLEFT:0,TOPRIGHT:1,BOTTOMLEFT:2,BOTTOMRIGHT:3};GCSDjimMolenkamp.PFDSettingsModel.Size={STANDARD:0,FULLSCREEN:1,SMALL:2,HIDDEN:3};GCSDjimMolenkamp.PFDSettingsModel.prototype.initialize=function(){this.bind("change",function(){this.writeToCookie()})};goog.exportSymbol("GCSDjimMolenkamp.PFDSettingsModel.prototype.initialize",GCSDjimMolenkamp.PFDSettingsModel.prototype.initialize);
GCSDjimMolenkamp.PFDSettingsModel.prototype.defaults=function(){var a=this.readFromCookie();return a?{position:a.position||GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT,size:a.size||GCSDjimMolenkamp.PFDSettingsModel.Size.STANDARD}:{position:GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT,size:GCSDjimMolenkamp.PFDSettingsModel.Size.STANDARD}};goog.exportSymbol("GCSDjimMolenkamp.PFDSettingsModel.prototype.defaults",GCSDjimMolenkamp.PFDSettingsModel.prototype.defaults);
GCSDjimMolenkamp.PFDSettingsModel.prototype.readFromCookie=function(){var a=$.cookie("pfdSettings");if(a){window.console.log("cookieData");window.console.log(a);try{return goog.json.parse(a)}catch(b){return window.console.warn("Unable to parse pfdSettings cookie data:"),window.console.warn(a),null}}else return null};GCSDjimMolenkamp.PFDSettingsModel.prototype.writeToCookie=function(){var a=goog.json.serialize(this.toJSON());window.console.log("writeToCookie:");window.console.log(a);$.cookie("pfdSettings",a)};GCSDjimMolenkamp.PFDView=function(a){this.pfd=null;this.settingToDimension={};Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.PFDView,Backbone.View);
GCSDjimMolenkamp.PFDView.prototype.initialize=function(){this.blockel=this.options.blockel;this.statel=this.options.statel;this.pfdel=$("#"+this.options.drawingid);var a=this.options.mavlinkSrc;this.attitude=a.subscribe("ATTITUDE",this.onAttitudeChange,this);this.vfrHud=a.subscribe("VFR_HUD",this.onVfrHudChange,this);this.navControllerOutput=a.subscribe("NAV_CONTROLLER_OUTPUT",this.onNavControllerOutputChange,this);this.pfd=new GCSDjimMolenkamp.PFD(this.options.drawingid);this.options.settingsModel&&(this.settingsModel=
this.options.settingsModel,this.settingToDimension[GCSDjimMolenkamp.PFDSettingsModel.Size.STANDARD]={height:function(){return"280px"},width:function(){return"400px"}},this.settingToDimension[GCSDjimMolenkamp.PFDSettingsModel.Size.FULLSCREEN]={height:function(){return $(window).height()-120},width:function(){return $(window).width()}},this.settingToDimension[GCSDjimMolenkamp.PFDSettingsModel.Size.SMALL]={height:function(){return"140px"},width:function(){return"200px"}},this.settingsModel.bind("change",this.onSettingsChange,
this),this.onSettingsChange());this.onAttitudeChange();this.onVfrHudChange();this.onNavControllerOutputChange()};goog.exportSymbol("GCSDjimMolenkamp.PFDView.prototype.initialize",GCSDjimMolenkamp.PFDView.prototype.initialize);GCSDjimMolenkamp.PFDView.prototype.onAttitudeChange=function(){this.pfd.setAttitude(this.attitude.get("pitch"),this.attitude.get("roll"));this.pfd.draw()};
GCSDjimMolenkamp.PFDView.prototype.onVfrHudChange=function(){var a=this.vfrHud.get("alt");this.pfd.setAltitude(a);a=this.vfrHud.get("airspeed");this.pfd.setSpeed(a);this.pfd.draw()};GCSDjimMolenkamp.PFDView.prototype.onNavControllerOutputChange=function(){var a=this.navControllerOutput.get("alt_error"),b=this.navControllerOutput.get("aspd_error");0<Math.abs(a)&&this.pfd.setTargetAltitude(this.vfrHud.get("alt")+a);0<Math.abs(b)&&this.pfd.setTargetSpeed(this.vfrHud.get("airspeed")+b)};
GCSDjimMolenkamp.PFDView.prototype.onSettingsChange=function(){var a=this.settingsModel.toJSON();this.setPosition(a.position);this.setSize(a.size)};
GCSDjimMolenkamp.PFDView.prototype.setPosition=function(a){this.blockel.removeClass("pfd-top pfd-bottom pfd-left pfd-right");switch(a){case GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT:this.blockel.addClass("pfd-top pfd-left");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.TOPRIGHT:this.blockel.addClass("pfd-top pfd-right");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMLEFT:this.blockel.addClass("pfd-bottom pfd-left");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMRIGHT:this.blockel.addClass("pfd-bottom pfd-right")}};
GCSDjimMolenkamp.PFDView.prototype.setSize=function(a){goog.asserts.assert(goog.object.containsValue(GCSDjimMolenkamp.PFDSettingsModel.Size,a),"unknown PFD size value: "+a);var b=this.blockel;a==GCSDjimMolenkamp.PFDSettingsModel.Size.FULLSCREEN?$("#droneicon").addClass("droneicon-hide"):$("#droneicon").hasClass("droneicon-hide")&&$("#droneicon").removeClass("droneicon-hide");a==GCSDjimMolenkamp.PFDSettingsModel.Size.HIDDEN?(this.pfd.setVisible(!1),b.hide()):(b.is(":hidden")&&(this.pfd.setVisible(!0),b.show()),b=this.settingToDimension[a],
a=b.width(),b=b.height(),this.pfdel.width(a).height(b),this.blockel.width(a),this.statel.width(a),this.pfd.setSize(this.pfdel.width(),this.pfdel.height()))};GCSDjimMolenkamp.GuideAltitudeView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.GuideAltitudeView,Backbone.View);GCSDjimMolenkamp.GuideAltitudeView.prototype.initialize=function(){var a=this;this.input=this.options.input;this.submit=this.options.submit;this.text=this.options.text;this.model.bind("change",this.render,this);this.render();this.input.change(function(){a.model.set({alt:a.input.val()})});this.submit.click(function(){a.model.send()})};
goog.exportSymbol("GCSDjimMolenkamp.GuideAltitudeView.prototype.initialize",GCSDjimMolenkamp.GuideAltitudeView.prototype.initialize);GCSDjimMolenkamp.GuideAltitudeView.prototype.render=function(){var a=this.model.toJSON();this.text.html(a.alt.toString()+" m");this.input.val(a.alt);return this};goog.exportSymbol("GCSDjimMolenkamp.GuideAltitudeView.prototype.render",GCSDjimMolenkamp.GuideAltitudeView.prototype.render);GCSDjimMolenkamp.FakeVehicle=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.FakeVehicle,Backbone.Model);GCSDjimMolenkamp.FakeVehicle.prototype.defaults=function(){return{lat:37.7751,lon:-122.419,alt:30,heading:90,pitch:0,roll:0,velocity:10,t:0}};GCSDjimMolenkamp.FakeVehicle.prototype.initialize=function(){var a=Date.now();this.lastmessagetime=this.lastupdate=this.firstupdate=a};goog.exportSymbol("GCSDjimMolenkamp.FakeVehicle.prototype.initialize",GCSDjimMolenkamp.FakeVehicle.prototype.initialize);
GCSDjimMolenkamp.FakeVehicle.prototype.update=function(){var a=Date.now(),b=(a-this.lastupdate)/1E3,c=(a-this.firstupdate)/1E3,d=GCSDjimMolenkamp.FakeVehicle.nextposition(this,b),e=this.toJSON(),f=2*b*e.velocity*Math.sin(goog.math.toRadians(e.pitch)),b=4*b*e.velocity*Math.sin(goog.math.toRadians(e.roll));this.set({lat:d.lat,lon:d.lon,alt:e.alt+f,heading:e.heading+b,pitch:8*Math.sin(c),roll:5+15*Math.sin(c/2),t:c});this.lastupdate=a};
GCSDjimMolenkamp.FakeVehicle.prototype.requestMessages=function(a){var b=Date.now(),c=200<b-this.lastmessagetime;c&&(this.lastmessagetime=b);var d=this.toJSON(),e={};_.each(a,function(a,b){if(b in GCSDjimMolenkamp.FakeVehicle.fakeHandlers){var h=a.get("_index")||0;e[b]={index:c?h+1:h,msg:GCSDjimMolenkamp.FakeVehicle.fakeHandlers[b](d)}}});return e};GCSDjimMolenkamp.FakeVehicle.fakeAttitude=function(a){return{pitch:goog.math.toRadians(a.pitch),roll:goog.math.toRadians(a.roll)}};
GCSDjimMolenkamp.FakeVehicle.fakeVfrHud=function(a){return{heading:a.heading,alt:a.alt,airspeed:a.velocity}};GCSDjimMolenkamp.FakeVehicle.fakeNavControllerOutput=function(a){return{alt_error:30-a.alt,aspd_error:4-a.velocity}};GCSDjimMolenkamp.FakeVehicle.fakeGpsRawInt=function(a){return{fix_type:3,lat:Math.round(1E7*a.lat),lon:Math.round(1E7*a.lon)}};GCSDjimMolenkamp.FakeVehicle.fakeMetaWaypoint=function(a){return{}};GCSDjimMolenkamp.FakeVehicle.fakeHeartbeat=function(a){return{type:2,base_mode:129,custom_mode:3}};
GCSDjimMolenkamp.FakeVehicle.fakeMetaLinkquality=function(a){return{master_in:Math.floor(11*a.t),master_out:Math.floor(9*a.t),mav_loss:0}};GCSDjimMolenkamp.FakeVehicle.fakeGpsStatus=function(a){return{satellites_visible:8}};GCSDjimMolenkamp.FakeVehicle.fakeStatustext=function(a){return{text:"Offline mode"}};GCSDjimMolenkamp.FakeVehicle.fakeSysStatus=function(a){return{}};
GCSDjimMolenkamp.FakeVehicle.fakeHandlers={ATTITUDE:GCSDjimMolenkamp.FakeVehicle.fakeAttitude,VFR_HUD:GCSDjimMolenkamp.FakeVehicle.fakeVfrHud,NAV_CONTROLLER_OUTPUT:GCSDjimMolenkamp.FakeVehicle.fakeNavControllerOutput,GPS_RAW_INT:GCSDjimMolenkamp.FakeVehicle.fakeGpsRawInt,META_WAYPOINT:GCSDjimMolenkamp.FakeVehicle.fakeMetaWaypoint,HEARTBEAT:GCSDjimMolenkamp.FakeVehicle.fakeHeartbeat,META_LINKQUALITY:GCSDjimMolenkamp.FakeVehicle.fakeMetaLinkquality,GPS_STATUS:GCSDjimMolenkamp.FakeVehicle.fakeGpsStatus,STATUSTEXT:GCSDjimMolenkamp.FakeVehicle.fakeStatustext,SYS_STATUS:GCSDjimMolenkamp.FakeVehicle.fakeSysStatus};
GCSDjimMolenkamp.FakeVehicle.nextposition=function(a,b){var c=goog.math.toRadians(a.get("lat")),d=goog.math.toRadians(a.get("lon")),e=goog.math.toRadians(a.get("heading")),f=a.get("velocity")*b/1E3,g=Math.asin(Math.sin(c)*Math.cos(f/6371)+Math.cos(c)*Math.sin(f/6371)*Math.cos(e)),e=Math.sin(e)*Math.sin(f/6371)*Math.cos(c),c=Math.cos(f/6371)-Math.sin(c)*Math.sin(g),d=d+Math.atan2(e,c),d=(d+Math.PI)%(2*Math.PI)-Math.PI;if(isNaN(g)||isNaN(d))throw Error("nope");return{lat:goog.math.toDegrees(g),lon:goog.math.toDegrees(d)}};goog.structs={};goog.structs.Collection=function(){};goog.structs.getCount=function(a){return"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if("function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
...
goog.debug.LogManager.createLogger_=function(a){var b=new goog.debug.Logger(a);if(goog.debug.Logger.ENABLE_HIERARCHY){var c=a.lastIndexOf("."),d=a.substr(0,c),c=a.substr(c+1),d=goog.debug.LogManager.getLogger(d);d.addChild_(c,b);b.setParent_(d)}return goog.debug.LogManager.loggers_[a]=b};GCSDjimMolenkamp.MavlinkMessage=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.MavlinkMessage,Backbone.Model);GCSDjimMolenkamp.MavlinkAPI=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.MavlinkAPI,Backbone.Model);GCSDjimMolenkamp.MavlinkAPI.prototype.initialize=function(){this.logger_=goog.debug.Logger.getLogger("mavelous.MavlinkAPI");this.url=this.get("url");this.gotonline=!1;this.online=!0;this.failcount=0;this.messageModels={};this.fakevehicle=null};
goog.exportSymbol("GCSDjimMolenkamp.MavlinkAPI.prototype.initialize",GCSDjimMolenkamp.MavlinkAPI.prototype.initialize);GCSDjimMolenkamp.MavlinkAPI.prototype.subscribe=function(a,b,c){this.messageModels[a]||(this.messageModels[a]=new GCSDjimMolenkamp.MavlinkMessage({_type:a,_index:-1}));a=this.messageModels[a];a.bind("change",b,c);return a};GCSDjimMolenkamp.MavlinkAPI.prototype.handleMessages_=function(a){this.trigger("gotServerResponse");_.each(a,this.handleMessage_,this)};
GCSDjimMolenkamp.MavlinkAPI.prototype.handleMessage_=function(a,b){var c=this.messageModels[b],d=c.get("_index");if(void 0===d||a.index>d)c.set({_index:a.index},{silent:!0}),c.set(a.msg)};GCSDjimMolenkamp.MavlinkAPI.prototype.update=function(){if(this.online)this.onlineUpdate();else this.offlineUpdate()};
GCSDjimMolenkamp.MavlinkAPI.prototype.onlineUpdate=function(){$.ajax({context:this,type:"GET",cache:!1,url:this.url+_.keys(this.messageModels).join("+"),datatype:"json",success:function(a){this.gotonline=!0;this.handleMessages_(a)},error:function(){this.trigger("gotServerError");this.gotonline||(this.failcount++,5<this.failcount&&this.useOfflineMode())}})};
GCSDjimMolenkamp.MavlinkAPI.prototype.offlineUpdate=function(){goog.asserts.assert(this.fakevehicle);this.fakevehicle.update();var a=this.fakevehicle.requestMessages(this.messageModels);this.handleMessages_(a)};GCSDjimMolenkamp.MavlinkAPI.prototype.useOfflineMode=function(){this.online&&!this.gotonline&&(this.logger_.info("Switching to offline mode"),this.online=!1,this.fakevehicle=new GCSDjimMolenkamp.FakeVehicle({lat:45.5233,lon:-122.667}))};GCSDjimMolenkamp.FlightModeModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.FlightModeModel,Backbone.Model);GCSDjimMolenkamp.FlightModeModel.prototype.defaults=function(){return{armed:!1,arming:!1,disarming:!1,modestring:"None"}};goog.exportSymbol("GCSDjimMolenkamp.FlightModeModel.prototype.defaults",GCSDjimMolenkamp.FlightModeModel.prototype.defaults);
GCSDjimMolenkamp.FlightModeModel.prototype.initialize=function(){this.heartbeat=this.get("mavlinkSrc").subscribe("HEARTBEAT",this.onHeartbeat,this);this.on("change:armed",this.onChangeArmed,this)};goog.exportSymbol("GCSDjimMolenkamp.FlightModeModel.prototype.initialize",GCSDjimMolenkamp.FlightModeModel.prototype.initialize);GCSDjimMolenkamp.FlightModeModel.prototype.onHeartbeat=function(){var a=GCSDjimMolenkamp.util.heartbeat.modestring(this.heartbeat),b=GCSDjimMolenkamp.util.heartbeat.armed(this.heartbeat);this.set({armed:b,modestring:a})};
GCSDjimMolenkamp.FlightModeModel.prototype.onChangeArmed=function(){this.get("armed")?this.get("arming")&&this.set("arming",!1):this.get("disarming")&&this.set("disarming",!1)};GCSDjimMolenkamp.FlightModeModel.prototype.requestArm=function(){this.postArmRequest_(!0);this.set("arming",!0)};GCSDjimMolenkamp.FlightModeModel.prototype.requestDisarm=function(){this.postArmRequest_(!1);this.set("disarming",!0)};
GCSDjimMolenkamp.FlightModeModel.prototype.postArmRequest_=function(a){$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:"COMPONENT_ARM_DISARM",component:"SYSTEM_CONTROL",setting:a?"ARM":"DISARM"})})};GCSDjimMolenkamp.CommandLongModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.CommandLongModel,Backbone.Model);
GCSDjimMolenkamp.CommandLongModel.prototype.post=function(a){"string"==typeof a?$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:a})}):$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize(a)})};GCSDjimMolenkamp.ArmingButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.ArmingButtonView,Backbone.View);
GCSDjimMolenkamp.ArmingButtonView.prototype.initialize=function(){this.model.on("change:armed change:arming change:disarming",this.onChange_,this);this.$el.click(goog.bind(this.onClick_,this));this.onChange_()};goog.exportSymbol("GCSDjimMolenkamp.ArmingButtonView.prototype.initialize",GCSDjimMolenkamp.ArmingButtonView.prototype.initialize);GCSDjimMolenkamp.ArmingButtonView.prototype.onClick_=function(){this.model.get("armed")?this.model.requestDisarm():this.model.requestArm()};
GCSDjimMolenkamp.ArmingButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.model.get("armed")?(this.model.get("disarming")?this.$el.html("Disarming..."):this.$el.html("Click to Disarm"),this.$el.addClass("btn-warning")):(this.model.get("arming")?this.$el.html("Arming..."):this.$el.html("Click to Arm"),this.$el.addClass("btn-success"))};GCSDjimMolenkamp.CommandButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.CommandButtonView,Backbone.View);
GCSDjimMolenkamp.CommandButtonView.prototype.initialize=function(){this.command=this.options.command;this.$el.click(goog.bind(this.onClick_,this))};goog.exportSymbol("GCSDjimMolenkamp.CommandButtonView.prototype.initialize",GCSDjimMolenkamp.CommandButtonView.prototype.initialize);GCSDjimMolenkamp.CommandButtonView.prototype.onClick_=function(){this.model.post(this.command)};GCSDjimMolenkamp.FlightModeButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.FlightModeButtonView,Backbone.View);
GCSDjimMolenkamp.FlightModeButtonView.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.$el=this.options.el;this.modeModel.on("change",this.onChange_,this)};goog.exportSymbol("GCSDjimMolenkamp.FlightModeButtonView.prototype.initialize",GCSDjimMolenkamp.FlightModeButtonView.prototype.initialize);GCSDjimMolenkamp.FlightModeButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.modeModel.get("armed")?this.$el.addClass("btn-success"):this.$el.addClass("btn-warning");this.$el.html(this.modeModel.get("modestring"))};GCSDjimMolenkamp.SettingsView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.SettingsView,Backbone.View);
GCSDjimMolenkamp.SettingsView.prototype.initialize=function(){var a=this;this.modalToggle=this.options.modalToggle;this.modal=this.options.modal;this.modalToggle.click(function(){a.modal.modal("toggle")});this.map=this.options.map;this.mapView=this.options.mapView;this.mapProviderModel=this.options.mapProviderModel;this.vehicleIconModel=this.options.vehicleIconModel;this.mapProviderPicker=this.options.mapProviderPicker;this.mapZoomSlider=this.options.mapZoomSlider;this.mapZoomValue=this.options.mapZoomValue;
...
goog.exportSymbol("GCSDjimMolenkamp.SettingsView.prototype.initialize",GCSDjimMolenkamp.SettingsView.prototype.initialize);GCSDjimMolenkamp.SettingsView.prototype.setupMapProviderPicker=function(){var a=this;void 0!==this.mapProviderModel&&(_.each(GCSDjimMolenkamp.LeafletProviders.Providers,function(b,c){a.mapProviderPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.mapProviderPicker.change(function(){var b=a.mapProviderPicker.val();a.mapProviderModel.set("provider",b)}))};
GCSDjimMolenkamp.SettingsView.prototype.setupMapZoomSlider=function(){var a=this;void 0!==this.map&&(this.mapZoomSlider.change(function(){a.map.setZoom(a.mapZoomSlider.val())}),this.map.on("zoomend",this.onZoomChange,this))};GCSDjimMolenkamp.SettingsView.prototype.setupMapPathPicker=function(){var a=this;void 0!==this.map&&this.mapPathPicker.change(function(){var b=a.mapPathPicker.val();a.mapView.setPathVisible(b)})};
GCSDjimMolenkamp.SettingsView.prototype.setupVehicleIconPicker=function(){var a=this;void 0!==this.vehicleIconModel&&(_.each(GCSDjimMolenkamp.LeafletDroneIconModel.Icons,function(b,c){a.vehicleIconPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.vehicleIconPicker.change(function(){var b=a.vehicleIconPicker.val();a.vehicleIconModel.set("icon",b)}))};GCSDjimMolenkamp.SettingsView.prototype.onZoomChange=function(){this.mapZoomSlider.val(this.map.getZoom());this.mapZoomValue.html(this.map.getZoom().toString())};
GCSDjimMolenkamp.SettingsView.prototype.setupPFDSettings=function(){var a=this;this.pfdPositionLeft.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMLEFT)});this.pfdPositionRight.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.TOPRIGHT):a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMRIGHT)});
this.pfdPositionUp.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.TOPRIGHT)});this.pfdPositionDown.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMLEFT):a.pfdSettingsModel.set("position",GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMRIGHT)});this.pfdSettingsModel.bind("change",
this.onPFDSettingsChange,this);this.onPFDSettingsChange()};
GCSDjimMolenkamp.SettingsView.prototype.onPFDSettingsChange=function(){switch(this.pfdSettingsModel.get("position")){case GCSDjimMolenkamp.PFDSettingsModel.Position.TOPLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionUp.button("toggle");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.TOPRIGHT:this.pfdPositionRight.button("toggle");this.pfdPositionUp.button("toggle");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionDown.button("toggle");break;case GCSDjimMolenkamp.PFDSettingsModel.Position.BOTTOMRIGHT:this.pfdPositionRight.button("toggle"),
this.pfdPositionDown.button("toggle")}};var markerIcon=L.Icon.extend({options:{iconUrl:"third_party/leaflet/images/marker-icon.png",shadowUrl:"third_party/leaflet/images/marker-shadow.png",iconAnchor:new L.Point(13,41),iconSize:new L.Point(25,41)}});L.Transition=null;GCSDjimMolenkamp.UnanimatedMap=function(a,b){L.Map.call(this,a,b)};goog.inherits(GCSDjimMolenkamp.UnanimatedMap,L.Map);
GCSDjimMolenkamp.UnanimatedMap.prototype.panTo=function(a){a=this._getNewTopLeftPoint(a).subtract(this._getTopLeftPoint());this.fire("movestart");this._rawPanBy(a);this.fire("move");this.fire("moveend")};GCSDjimMolenkamp.LeafletView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.LeafletView,Backbone.View);
GCSDjimMolenkamp.LeafletView.prototype.initialize=function(){this.vehicleModel=this.options.vehicle;this.vehicleIconModel=this.options.vehicleIcon;this.providerModel=this.options.provider;this.guideModel=this.options.guideModel;this.panModel=this.options.panModel;this.initializedcenter=!1;this.vehiclePathVisible=!0;this.tileLayer=this.providerModel.getProvider();this.touchzoomable=L.Browser.touch&&!L.Browser.android23;this.map=new GCSDjimMolenkamp.UnanimatedMap("map",{layers:[this.tileLayer],zoomControl:!1,doubleClickZoom:!1,
...
this);this.vehicleModel.bind("change",this.updateVehiclePath,this);this.map.addEventListener("dblclick",this.doubleClickHandler,this);this.guideModel.bind("change",this.updateGuideMarker,this)};goog.exportSymbol("GCSDjimMolenkamp.LeafletView.prototype.initialize",GCSDjimMolenkamp.LeafletView.prototype.initialize);GCSDjimMolenkamp.LeafletView.prototype.doubleClickHandler=function(a){this.guideModel.setTarget({lat:a.latlng.lat,lon:a.latlng.lng})};
GCSDjimMolenkamp.LeafletView.prototype.providerChange=function(){this.map.removeLayer(this.tileLayer);this.tileLayer=this.providerModel.getProvider();this.map.addLayer(this.tileLayer)};GCSDjimMolenkamp.LeafletView.prototype.panModelChange=function(){var a=this.panModel.get("center");void 0!==a&&(this.initializedcenter?this.map.panTo(a):(this.map.setView(a,16),this.initializedcenter=!0))};
GCSDjimMolenkamp.LeafletView.prototype.panTrackingChange=function(){var a=this.panModel.get("tracking");void 0!==a&&(a?(this.map.scrollWheelZoom.disable(),this.map.centerScrollWheelZoom.enable(),this.map.touchZoom.disable(),this.touchzoomable&&this.map.centerTouchZoom.enable()):(this.map.scrollWheelZoom.enable(),this.map.centerScrollWheelZoom.disable(),this.map.centerTouchZoom.disable(),this.touchzoomable&&this.map.touchZoom.enable()))};
GCSDjimMolenkamp.LeafletView.prototype.updateVehicleMarker=function(){if(this.initializedcenter){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(void 0===this.vehicleMarker?(this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker)):(this.vehicleMarker.setLatLng(a),this.vehicleMarker.setIconAngle(b)))}};
GCSDjimMolenkamp.LeafletView.prototype.vehicleIconChange=function(){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(this.map.removeLayer(this.vehicleMarker),this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker))};
GCSDjimMolenkamp.LeafletView.prototype.setPathVisible=function(a){void 0===this.vehiclePathVisible&&(this.vehiclePathVisible=!0);"on"==a&&(this.vehiclePathVisible=!0);"off"==a&&(this.vehiclePathVisible=!1,this.map.removeLayer(this.vehiclePath),this.vehiclePath=void 0)};
GCSDjimMolenkamp.LeafletView.prototype.updateVehiclePath=function(){var a=this.vehicleModel.get("position");a&&!1!=this.vehiclePathVisible&&(void 0===this.vehiclePath?(this.vehiclePath=new L.Polyline([a],{color:"red"}),this.vehiclePath.addTo(this.map)):this.vehiclePath.addLatLng(a))};
GCSDjimMolenkamp.LeafletView.prototype.updateGuideMarker=function(){var a=this.guideModel.toJSON(),b=new L.LatLng(a.lat,a.lon);a&&(void 0===this.guideMarker?(this.guideMarker=new L.Marker(b,{icon:new markerIcon}),this.map.addLayer(this.guideMarker)):this.guideMarker.setLatLng(b))};GCSDjimMolenkamp.VehicleLeafletPosition=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.VehicleLeafletPosition,Backbone.Model);GCSDjimMolenkamp.VehicleLeafletPosition.prototype.defaults=function(){return{position:null,heading:0}};goog.exportSymbol("GCSDjimMolenkamp.VehicleLeafletPosition.prototype.defaults",GCSDjimMolenkamp.VehicleLeafletPosition.prototype.defaults);
GCSDjimMolenkamp.VehicleLeafletPosition.prototype.initialize=function(){var a=this.get("mavlinkSrc");this.vehicleGps=a.subscribe("GPS_RAW_INT",this.withVehicleGps,this);this.vehicleHead=a.subscribe("VFR_HUD",this.withVehicleHead,this)};goog.exportSymbol("GCSDjimMolenkamp.VehicleLeafletPosition.prototype.initialize",GCSDjimMolenkamp.VehicleLeafletPosition.prototype.initialize);
GCSDjimMolenkamp.VehicleLeafletPosition.prototype.withVehicleGps=function(){var a=this.vehicleGps.toJSON();0===a.lat&&0===a.lon||this.set("position",new L.LatLng(a.lat/1E7,a.lon/1E7))};GCSDjimMolenkamp.VehicleLeafletPosition.prototype.withVehicleHead=function(){var a=this.vehicleHead.get("heading");this.set("heading",a)};GCSDjimMolenkamp.GuideModel=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.GuideModel,Backbone.Model);GCSDjimMolenkamp.GuideModel.prototype.defaults=function(){return{alt:20,lat:null,lon:null}};goog.exportSymbol("GCSDjimMolenkamp.GuideModel.prototype.defaults",GCSDjimMolenkamp.GuideModel.prototype.defaults);GCSDjimMolenkamp.GuideModel.prototype.initialize=function(){this.metaWaypointModel=this.get("mavlinkSrc").subscribe("META_WAYPOINT",this.onMetaWaypointChange,this)};
goog.exportSymbol("GCSDjimMolenkamp.GuideModel.prototype.initialize",GCSDjimMolenkamp.GuideModel.prototype.initialize);GCSDjimMolenkamp.GuideModel.prototype.onMetaWaypointChange=function(){var a=this.metaWaypointModel.get("waypoint");a&&this.set({alt:a.alt,lat:a.lat,lon:a.lon})};GCSDjimMolenkamp.GuideModel.prototype.setTarget=function(a){this.set(a);this.send()};GCSDjimMolenkamp.GuideModel.prototype.send=function(){var a={lat:this.get("lat"),lon:this.get("lon"),alt:this.get("alt")};null!==a.lat&&(null!==a.lon&&null!==a.alt)&&this.sendServer(a)};
GCSDjimMolenkamp.GuideModel.prototype.sendServer=function(a){a=goog.json.serialize({command:"FLYTO",location:a});$.ajax({type:"POST",url:"/guide",data:a})};GCSDjimMolenkamp.LeafletProviders=function(a){Backbone.Model.call(this,a)};goog.inherits(GCSDjimMolenkamp.LeafletProviders,Backbone.Model);GCSDjimMolenkamp.LeafletProviders.bingKey="AnFxXUB376BgaEQMj947c43V45ipmMvdcoY-TAE4-Y23mu1yFLHF0k2BMJP-MU1B";GCSDjimMolenkamp.LeafletProviders.prototype.defaults=function(){return{provider:"bing"}};goog.exportSymbol("GCSDjimMolenkamp.LeafletProviders.prototype.defaults",GCSDjimMolenkamp.LeafletProviders.prototype.defaults);
GCSDjimMolenkamp.LeafletProviders.prototype.getProvider=function(){var a=this.get("provider");return GCSDjimMolenkamp.LeafletProviders.Providers[a].constructor()};
GCSDjimMolenkamp.LeafletProviders.Providers={bing:{description:"Bing Satellite with Labels",constructor:function(){return new L.BingLayer(GCSDjimMolenkamp.LeafletProviders.bingKey,{type:"AerialWithLabels",maxZoom:21})}},cloudmade:{description:"Cloudmade Road Map",constructor:function(){return new L.TileLayer("http://{s}.tile.cloudmade.com/420c27bae8514670a02a1684e8398d33/997/256/{z}/{x}/{y}.png",{maxZoom:18})}},osm:{description:"OpenStreetMaps",constructor:function(){return new L.TileLayer("http://{s}.tile.openstreetmap.org//{z}/{x}/{y}.png",
...
goog.Uri.QueryData.prototype.extend=function(a){for(var b=0;b<arguments.length;b++)goog.structs.forEach(arguments[b],function(a,b){this.add(b,a)},this)};GCSDjimMolenkamp.CommStatusPopoverViewDelegate=function(a){this.popoverTitle="Link Info";this.$el=null;Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.CommStatusPopoverViewDelegate,Backbone.View);GCSDjimMolenkamp.CommStatusPopoverViewDelegate.prototype.initialize=function(){this.packetLossModel=this.options.packetLossModel;this.packetLossModel.bind("change",this.render,this)};
GCSDjimMolenkamp.CommStatusPopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.render()};GCSDjimMolenkamp.CommStatusPopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null};GCSDjimMolenkamp.CommStatusPopoverViewDelegate.prototype.render=function(){if(this.$el){var a=this.packetLossModel.getDelta(),a=this.packetLossString_(a);this.$el.find(".popover-content").html(a)}};
GCSDjimMolenkamp.CommStatusPopoverViewDelegate.prototype.packetLossString_=function(a){return"In last "+a.period+"s, "+a.master_in+" packets received, "+a.master_out+" sent, "+a.mav_loss+" lost"};GCSDjimMolenkamp.RadioButtonPopoverView=function(a){Backbone.View.call(this,a)};goog.inherits(GCSDjimMolenkamp.RadioButtonPopoverView,Backbone.View);GCSDjimMolenkamp.RadioButtonPopoverView.prototype.initialize=function(){var a=this;this.popoverViews=goog.array.map(this.options.popovers,function(b){goog.object.extend(b,{radioBtnController:a});return new GCSDjimMolenkamp.PopoverView(b)})};goog.exportSymbol("GCSDjimMolenkamp.RadioButtonPopoverView.prototype.initialize",GCSDjimMolenkamp.RadioButtonPopoverView.prototype.initialize);
...
goog.debug.Console.show=function(){alert(goog.debug.Console.instance.logBuffer_)};goog.debug.Console.logToConsole_=function(a,b,c){if(a[b])a[b](c);else a.log(c)};GCSDjimMolenkamp.App=function(){};
GCSDjimMolenkamp.App.prototype.start=function(){(new goog.debug.Console).setCapturing(!0);var a=new goog.Uri(window.location.href);this.mavlinkAPI=new GCSDjimMolenkamp.MavlinkAPI({url:"/mavlink/"});goog.isDef(a.getParameterValue("offline"))&&this.mavlinkAPI.useOfflineMode();a=a.getParameterValue("debug");if(goog.isDef(a)){window.console.log("Enabling debug mode");var b=document.getElementById("fps"),c=goog.dom.createDom("span",{id:"fpsvalue"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,goog.dom.createTextNode(" fps"));
(new goog.debug.FpsDisplay).decorate(c);0<a.length&&(window.console.log("Enabling phonegap at http://debug.phonegap.com/client/#"+a),goog.net.jsloader.load("http://debug.phonegap.com/target/target-script-min.js#"+a))}this.pfdSettingsModel=new GCSDjimMolenkamp.PFDSettingsModel;this.pfdView=new GCSDjimMolenkamp.PFDView({mavlinkSrc:this.mavlinkAPI,settingsModel:this.pfdSettingsModel,drawingid:"pfdview",blockel:$("#pfdblock"),statel:$("#pfdstatus")});this.guideModel=new GCSDjimMolenkamp.GuideModel({mavlinkSrc:this.mavlinkAPI});
this.guideAltView=new GCSDjimMolenkamp.GuideAltitudeView({model:this.guideModel,input:$("#guidealt-input"),submit:$("#guidealt-submit"),text:$("#guidealt-text")});this.leafletDroneIcon=new GCSDjimMolenkamp.LeafletDroneIconModel;this.leafletProviders=new GCSDjimMolenkamp.LeafletProviders;this.vehicle=new GCSDjimMolenkamp.VehicleLeafletPosition({mavlinkSrc:this.mavlinkAPI});this.panModel=new GCSDjimMolenkamp.LeafletPanModel({vehicle:this.vehicle});this.panCtrl=new GCSDjimMolenkamp.LeafletPanControlView({model:this.panModel,button:$("#mapoverlay-btn-centermap"),
icon:$("#mapoverlay-icon-centermap")});this.mapView=new GCSDjimMolenkamp.LeafletView({vehicle:this.vehicle,provider:this.leafletProviders,vehicleIcon:this.leafletDroneIcon,guideModel:this.guideModel,panModel:this.panModel});this.commStatusModel=new GCSDjimMolenkamp.CommStatusModel({mavlinkSrc:this.mavlinkAPI});this.packetLossModel=new GCSDjimMolenkamp.PacketLossModel({mavlinkSrc:this.mavlinkAPI});this.commStatusButtonView=new GCSDjimMolenkamp.CommStatusButtonView({commStatusModel:this.commStatusModel,packetLossModel:this.packetLossModel,
el:$("#navbar-btn-link")});this.gpsButtonView=new GCSDjimMolenkamp.GpsButtonView({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-gps")});this.statustextView=new GCSDjimMolenkamp.StatustextView({mavlinkSrc:this.mavlinkAPI});this.modeStringView=new GCSDjimMolenkamp.ModeStringView({mavlinkSrc:this.mavlinkAPI,el:$("#pfd_modestringview")});this.flightModeModel=new GCSDjimMolenkamp.FlightModeModel({mavlinkSrc:this.mavlinkAPI});this.flightCommandModel=new GCSDjimMolenkamp.CommandLongModel({mavlinkSrc:this.mavlinkAPI});this.flightModeButtonView=
new GCSDjimMolenkamp.FlightModeButtonView({el:$("#navbar-btn-mode"),modeModel:this.flightModeModel});this.statusButtons=new GCSDjimMolenkamp.RadioButtonPopoverView({popovers:[{btn:this.gpsButtonView,delegate:new GCSDjimMolenkamp.GpsPopoverViewDelegate({mavlinkSrc:this.mavlinkAPI})},{btn:this.commStatusButtonView,delegate:new GCSDjimMolenkamp.CommStatusPopoverViewDelegate({packetLossModel:this.packetLossModel})},{btn:this.flightModeButtonView,delegate:new GCSDjimMolenkamp.FlightModePopoverViewDelegate({modeModel:this.flightModeModel,commandModel:this.flightCommandModel})}]});
this.batteryButton=new GCSDjimMolenkamp.BatteryButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-battery")});this.settingsView=new GCSDjimMolenkamp.SettingsView({map:this.mapView.map,mapView:this.mapView,mapProviderModel:this.leafletProviders,vehicleIconModel:this.leafletDroneIcon,modalToggle:$("#navbar-a-settings"),modal:$("#settings-modal"),mapProviderPicker:$("#settings-mapproviderpicker"),mapZoomSlider:$("#settings-mapzoom"),mapZoomValue:$("#settings-mapzoom-value"),mapPathPicker:$("#settings-mappathpicker"),
vehicleIconPicker:$("#settings-vehicleiconpicker"),pfdSettingsModel:this.pfdSettingsModel,pfdPositionLeft:$("#settings-pfdpos-left"),pfdPositionRight:$("#settings-pfdpos-right"),pfdPositionUp:$("#settings-pfdpos-up"),pfdPositionDown:$("#settings-pfdpos-down")});this.router=new GCSDjimMolenkamp.AppRouter({pfdSettingsModel:this.pfdSettingsModel});Backbone.history.start();767<$(window).width()?this.router.navigate("overview",{trigger:!0}):this.router.navigate("maponly",{trigger:!0});var d=null,e=new goog.async.Throttle(function(){this.mavlinkAPI.update();
d.start()},100,this),d=new goog.async.AnimationDelay(function(){e.fire()});d.start()};goog.exportSymbol("GCSDjimMolenkamp.App",GCSDjimMolenkamp.App);goog.exportSymbol("GCSDjimMolenkamp.App.prototype.start",GCSDjimMolenkamp.App.prototype.start);
