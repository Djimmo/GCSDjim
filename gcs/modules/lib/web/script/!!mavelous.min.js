...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};var MineGCS={util:{}};MineGCS.util.heartbeat={};MineGCS.util.MavModeFlag={CUSTOM_MODE_ENABLED:1,TEST_ENABLED:2,AUTO_ENABLED:4,GUIDED_ENABLED:8,STABILIZE_ENABLED:16,HIL_ENABLED:32,MANUAL_INPUT_ENABLED:64,SAFETY_ARMED:128};MineGCS.util.MavType={FIXED_WING:1,QUADROTOR:2};MineGCS.util.ArduPlaneFlightModes={0:"MANUAL",1:"CIRCLE",2:"STABILIZE",5:"FBWA",6:"FBWB",7:"FBWC",10:"AUTO",11:"RTL",12:"LOITER",13:"TAKEOFF",14:"LAND",15:"GUIDED",16:"INITIALIZING"};
MineGCS.util.ArduCopterFlightModes={0:"STABILIZE",1:"ACRO",2:"ALT_HOLD",3:"AUTO",4:"GUIDED",5:"LOITER",6:"RTL",7:"CIRCLE",8:"POSITION",9:"LAND",10:"OF_LOITER",11:"APPROACH"};MineGCS.util.heartbeat.mavtype=function(a){a=a.get("type");return a==MineGCS.util.MavType.QUADROTOR?"ArduCopter":a==MineGCS.util.MavType.FIXED_WING?"ArduPlane":"unknown"};
MineGCS.util.heartbeat.modestring=function(a){var b=a.get("base_mode"),c=a.get("type");a=a.get("custom_mode");return null===b||null===c||null===a?"badmode":!b&MineGCS.util.MavModeFlag.CUSTOM_MODE_ENABLED?"BaseMode("+b+")":c==MineGCS.util.MavType.QUADROTOR&&goog.object.containsKey(MineGCS.util.ArduCopterFlightModes,a)?MineGCS.util.ArduCopterFlightModes[a]:c==MineGCS.util.MavType.FIXED_WING&&goog.object.containsKey(MineGCS.util.ArduPlaneFlightModes,a)?MineGCS.util.ArduPlaneFlightModes[a]:"CustomMode("+
a+")"};MineGCS.util.heartbeat.armed=function(a){a=a.get("base_mode");return null===a?null:a&MineGCS.util.MavModeFlag.SAFETY_ARMED?!0:!1};MineGCS.ModeStringView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.ModeStringView,Backbone.View);MineGCS.ModeStringView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=this.options.el;this.heartbeat=a.subscribe("HEARTBEAT",this.onHeartbeat,this)};goog.exportSymbol("MineGCS.ModeStringView.prototype.initialize",MineGCS.ModeStringView.prototype.initialize);
MineGCS.ModeStringView.prototype.onHeartbeat=function(){var a=MineGCS.util.heartbeat.modestring(this.heartbeat),b=MineGCS.util.heartbeat.armed(this.heartbeat);a&&this.$el.html(b?a+' <span class="ok">ARMED</span>':a+' <span class="slow">DISARMED</span>')};MineGCS.StatustextView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.StatustextView,Backbone.View);MineGCS.StatustextView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=$("#statustextview");this.statusText=a.subscribe("STATUSTEXT",this.onStatusTextChange,this);this.onStatusTextChange()};goog.exportSymbol("MineGCS.StatustextView.prototype.initialize",MineGCS.StatustextView.prototype.initialize);
MineGCS.StatustextView.prototype.onStatusTextChange=function(){clearTimeout(this.timeout);var a=this.$el;a.html(this.statusText.get("text"));a.css("padding",10);this.timeout=setTimeout(function(){a.html("");a.css("padding",0)},4E3)};MineGCS.GpsTextView={};MineGCS.GpsButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.GpsButtonView,Backbone.View);MineGCS.GpsButtonView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.renderTemplate_();this.gps=a.subscribe("GPS_RAW_INT",this.onGPS_,this)};goog.exportSymbol("MineGCS.GpsButtonView.prototype.initialize",MineGCS.GpsButtonView.prototype.initialize);
MineGCS.GpsButtonView.prototype.renderTemplate_=function(){var a;a='<span class="hidden-phone">GPS: <span id="gps-btn-lock-status"></span>';a+="</span>";a+='<i class="icon-globe icon-white visible-phone"></i>';this.$el.html(a);this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");this.$el.addClass("btn-inverse")};
MineGCS.GpsButtonView.prototype.renderFixType_=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");var b="btn-inverse",c="None";3<=a?(b="btn-success",c="3D"):2==a?(b="btn-warning",c="2D"):1==a&&(b="btn-danger",c="No Lock");this.$el.addClass(b);this.$el.find("#gps-btn-lock-status").text(c)};MineGCS.GpsButtonView.prototype.onGPS_=function(){var a=this.gps.get("fix_type");this.renderFixType_(a)};MineGCS.GpsPopoverViewDelegate=function(a){this.popoverTitle="GPS Info";Backbone.View.call(this,a)};goog.inherits(MineGCS.GpsPopoverViewDelegate,Backbone.View);MineGCS.GpsPopoverViewDelegate.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.gps=a.subscribe("GPS_RAW_INT",this.render,this);this.stat=a.subscribe("GPS_STATUS",this.render,this)};MineGCS.GpsPopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.render()};
MineGCS.GpsPopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null};
MineGCS.GpsPopoverViewDelegate.prototype.render=function(){if(this.$el){var a=this.stat.toJSON(),b=(this.gps.get("lat")/1E7).toFixed(7),c=(this.gps.get("lon")/1E7).toFixed(7),d="";"satellites_visible"in a&&(d+="Satellites: "+a.satellites_visible.toString()+"<br /> Coordinates: "+b+", "+c);a=this.gps.get("eph");"undefined"!=typeof a&&65535!=a&&(d+="<br />HDOP: "+(a/100).toFixed(2)+"m");a=this.gps.get("epv");"undefined"!=typeof a&&65535!=a&&(d+="<br />VDOP: "+(a/100).toFixed(2)+"m");this.$el.find(".popover-content").html(d)}};MineGCS.SelectionModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.SelectionModel,Backbone.Model);MineGCS.SelectionModel.prototype.defaults=function(){return{selected:!1}};goog.exportSymbol("MineGCS.SelectionModel.prototype.defaults",MineGCS.SelectionModel.prototype.defaults);
MineGCS.PopoverView=function(a){this.template='<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>';Backbone.View.call(this,a)};goog.inherits(MineGCS.PopoverView,Backbone.View);
MineGCS.PopoverView.prototype.initialize=function(){this.$el=null;this.btn=this.options.btn;this.placement=this.options.placement||"bottom";this.delegate=this.options.delegate;this.selectionModel=new MineGCS.SelectionModel;this.radioBtnController=this.options.radioBtnController;this.selectionModel.bind("change",this.onSelectionChange_,this);this.btn.$el.click(goog.bind(this.radioBtnController.onButtonClick,this.radioBtnController,this))};
goog.exportSymbol("MineGCS.PopoverView.prototype.initialize",MineGCS.PopoverView.prototype.initialize);MineGCS.PopoverView.prototype.select=function(){this.selectionModel.set("selected",!0)};MineGCS.PopoverView.prototype.deselect=function(){this.selectionModel.set("selected",!1)};MineGCS.PopoverView.prototype.selected=function(){return this.selectionModel.get("selected")};
MineGCS.PopoverView.prototype.onSelectionChange_=function(){if(this.selectionModel.get("selected")){this.createElement();var a=this.$el.find(".popover-inner");this.delegate.popoverCreated(a)}else this.delegate.popoverDestroyed(),this.destroyElement()};MineGCS.PopoverView.prototype.createElement=function(){this.$el=$(this.template);this.$el.removeClass("fade top bottom left right in");this.$el.remove().css({top:0,left:0,display:"block"}).appendTo(document.body);this.$el.css(this.placementStyle(this.placement)).addClass(this.placement).addClass("in")};
MineGCS.PopoverView.prototype.placementStyle=function(a){var b=$.extend({},this.btn.$el.offset(),{width:this.btn.$el[0].offsetWidth,height:this.btn.$el[0].offsetHeight}),c=this.$el[0].offsetWidth,d=this.$el[0].offsetHeight;switch(a){case "bottom":return{top:b.top+b.height,left:b.left+b.width/2-c/2};case "top":return{top:b.top-d,left:b.left+b.width/2-c/2};case "left":return{top:b.top+b.height/2-d/2,left:b.left-c};case "right":return{top:b.top+b.height/2-d/2,left:b.left+b.width}}};
MineGCS.PopoverView.prototype.destroyElement=function(){this.$el&&this.$el.remove()};MineGCS.BatteryButton=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.BatteryButton,Backbone.View);MineGCS.BatteryButton.prototype.initialize=function(){this.sysstatus=this.options.mavlinkSrc.subscribe("SYS_STATUS",this.onSysStatus,this);this.$el=this.options.el};goog.exportSymbol("MineGCS.BatteryButton.prototype.initialize",MineGCS.BatteryButton.prototype.initialize);
MineGCS.BatteryButton.prototype.onSysStatus=function(){var a=this.sysstatus,b=a.get("battery_remaining"),a=a.get("voltage_battery");30>b?this.setButton_("btn-warning",b.toFixed(0)+"%"):20>b?this.setButton_("btn-danger",b.toFixed(0)+"% "+a.toFixed(1)+"v"):void 0===b?this.setButton_("btn-inverse","Unknown"):this.setButton_("btn-success",b.toFixed(0)+"%")};
MineGCS.BatteryButton.prototype.setButton_=function(a,b){this.$el.removeClass("btn-success btn-warning btn-danger btn-inverse");this.$el.addClass(a);var c;c='<span class="hidden-phone">Batt: '+b+'</span><i class="icon-fire icon-white visible-phone"></i>';this.$el.html(c)};MineGCS.LeafletPanControlView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.LeafletPanControlView,Backbone.View);MineGCS.LeafletPanControlView.prototype.initialize=function(){this.button=this.options.button;this.icon=this.options.icon;this.button.click(goog.bind(this.onClick,this));this.model.on("change:tracking",this.onTrackingChange,this);this.onTrackingChange()};goog.exportSymbol("MineGCS.LeafletPanControlView.prototype.initialize",MineGCS.LeafletPanControlView.prototype.initialize);
MineGCS.LeafletPanControlView.prototype.onClick=function(){this.model.get("tracking")?this.model.set("tracking",!1):this.model.set("tracking",!0)};MineGCS.LeafletPanControlView.prototype.onTrackingChange=function(){this.model.get("tracking")?(this.button.addClass("btn-primary"),this.icon.removeClass("icon-black"),this.icon.addClass("icon-white")):(this.button.removeClass("btn-primary"),this.icon.removeClass("icon-white"),this.icon.addClass("icon-black"))};
MineGCS.LeafletPanModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.LeafletPanModel,Backbone.Model);MineGCS.LeafletPanModel.prototype.defaults=function(){return{initialized:!1,tracking:!0,center:void 0}};goog.exportSymbol("MineGCS.LeafletPanModel.prototype.defaults",MineGCS.LeafletPanModel.prototype.defaults);MineGCS.LeafletPanModel.prototype.initialize=function(){this.vehicle=this.get("vehicle");this.vehicle.on("change",this.onVehicleChange_,this)};
goog.exportSymbol("MineGCS.LeafletPanModel.prototype.initialize",MineGCS.LeafletPanModel.prototype.initialize);MineGCS.LeafletPanModel.prototype.onVehicleChange_=function(){var a=this.vehicle.get("position");this.get("initialized")?this.get("tracking")&&a&&(a.lat&&a.lng)&&this.set({center:a}):a&&(a.lat&&a.lng)&&this.set({center:a,initialized:!0})};MineGCS.LeafletPanModel.prototype.cancelTracking=function(){this.set("tracking",!1)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(this.creationStack=Error().stack,goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.instances_={};goog.Disposable.getUndisposedObjects=function(){var a=[],b;for(b in goog.Disposable.instances_)goog.Disposable.instances_.hasOwnProperty(b)&&a.push(goog.Disposable.instances_[Number(b)]);return a};
...
goog.async.Throttle.prototype.disposeInternal=function(){goog.async.Throttle.superClass_.disposeInternal.call(this);this.stop()};goog.async.Throttle.prototype.onTimer_=function(){this.timer_=null;this.shouldFire_&&!this.pauseCount_&&(this.shouldFire_=!1,this.doAction_())};goog.async.Throttle.prototype.doAction_=function(){this.timer_=goog.Timer.callOnce(this.callback_,this.interval_);this.listener_.call(this.handler_)};MineGCS.CommStatusModel=function(a){this.SERVER_TIMEOUT_INTERVAL=3E3;this.HEARTBEAT_TIMEOUT_INTERVAL=2E3;Backbone.Model.call(this,a)};goog.inherits(MineGCS.CommStatusModel,Backbone.Model);MineGCS.CommStatusModel.State={UNINITIALIZED:0,OK:1,TIMED_OUT_ONCE:2,TIMED_OUT_MANY:3,ERROR:4};MineGCS.CommStatusModel.prototype.defaults=function(){return{mav:MineGCS.CommStatusModel.State.UNINITIALIZED,server:MineGCS.CommStatusModel.State.UNINITIALIZED}};
goog.exportSymbol("MineGCS.CommStatusModel.prototype.defaults",MineGCS.CommStatusModel.prototype.defaults);MineGCS.CommStatusModel.prototype.initialize=function(){var a=this.get("mavlinkSrc");a.subscribe("HEARTBEAT",this.onHeartbeat,this);a.on("gotServerResponse",this.onServerSuccess,this);a.on("gotServerError",this.onServerError,this);this.resetServerTimeout()};goog.exportSymbol("MineGCS.CommStatusModel.prototype.initialize",MineGCS.CommStatusModel.prototype.initialize);
MineGCS.CommStatusModel.prototype.onHeartbeat=function(){this.set("mav",MineGCS.CommStatusModel.State.OK);this.resetHeartbeatTimeout()};MineGCS.CommStatusModel.prototype.resetHeartbeatTimeout=function(){var a=this;clearTimeout(this.heartbeatTimeout);this.heartbeatTimeout=setTimeout(function(){a.onHeartbeatTimeout()},this.HEARTBEAT_TIMEOUT_INTERVAL)};
MineGCS.CommStatusModel.prototype.onHeartbeatTimeout=function(){var a=this.get("mav");a===MineGCS.CommStatusModel.State.OK?this.set("mav",MineGCS.CommStatusModel.State.TIMED_OUT_ONCE):a===MineGCS.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("mav",MineGCS.CommStatusModel.State.TIMED_OUT_MANY);this.resetHeartbeatTimeout()};MineGCS.CommStatusModel.prototype.onServerSuccess=function(){this.set("server",MineGCS.CommStatusModel.State.OK);this.resetServerTimeout()};
MineGCS.CommStatusModel.prototype.onServerError=function(){this.set("server",MineGCS.CommStatusModel.State.ERROR)};MineGCS.CommStatusModel.prototype.resetServerTimeout=function(){var a=this;clearTimeout(this.serverTimeout);this.serverTimeout=setTimeout(function(){a.onServerTimeout()},this.SERVER_TIMEOUT_INTERVAL)};
MineGCS.CommStatusModel.prototype.onServerTimeout=function(){var a=this.get("server");a===MineGCS.CommStatusModel.State.OK?this.set("server",MineGCS.CommStatusModel.State.TIMED_OUT_ONCE):a===MineGCS.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("server",MineGCS.CommStatusModel.State.TIMED_OUT_MANY);this.resetServerTimeout()};MineGCS.PacketLossModel=function(a){this.period=10;Backbone.Model.call(this,a)};goog.inherits(MineGCS.PacketLossModel,Backbone.Model);
MineGCS.PacketLossModel.prototype.defaults=function(){return{history:[],current:-1}};goog.exportSymbol("MineGCS.PacketLossModel.prototype.defaults",MineGCS.PacketLossModel.prototype.defaults);MineGCS.PacketLossModel.prototype.initialize=function(){this.metalinkquality=this.get("mavlinkSrc").subscribe("META_LINKQUALITY",this.onMessage,this)};goog.exportSymbol("MineGCS.PacketLossModel.prototype.initialize",MineGCS.PacketLossModel.prototype.initialize);
MineGCS.PacketLossModel.prototype.onMessage=function(){var a=this.get("history"),b=this.get("current"),c=this.metalinkquality.toJSON(),b=(b+1)%(this.period+1);a[b]=c;this.set("history",a);this.set("current",b)};MineGCS.PacketLossModel.prototype.getDelta=function(){var a=this.get("history"),b=this.get("current");if(0>b)return null;var c=a[(b+1)%(this.period+1)];return c?this.diff(a[b],c,this.period):this.diff(a[b],a[0],b)};
MineGCS.PacketLossModel.prototype.diff=function(a,b,c){return{master_in:a.master_in-b.master_in,master_out:a.master_out-b.master_out,mav_loss:a.mav_loss-b.mav_loss,period:c}};MineGCS.CommStatusButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.CommStatusButtonView,Backbone.View);MineGCS.CommStatusButtonView.prototype.initialize=function(){this.commStatusModel=this.options.commStatusModel;this.commStatusModel.bind("change",this.buttonRender,this)};
goog.exportSymbol("MineGCS.CommStatusButtonView.prototype.initialize",MineGCS.CommStatusButtonView.prototype.initialize);
MineGCS.CommStatusButtonView.prototype.buttonRender=function(){var a=this.commStatusModel.toJSON(),b=a.server,a=a.mav,c=MineGCS.CommStatusModel.State.UNINITIALIZED,d=MineGCS.CommStatusModel.State.OK,e=MineGCS.CommStatusModel.State.TIMED_OUT_ONCE,f=MineGCS.CommStatusModel.State.TIMED_OUT_MANY,g=MineGCS.CommStatusModel.State.ERROR;b===d&&a===d?this.setButton(d):b===c||a===c?this.setButton(c):b===f||a===f?this.setButton(f):b===e||a===e?this.setButton(e):b===g||a===g?this.setButton(g):goog.asserts.assert(!1,
"Unknown comm status: "+b+"/"+a)};
MineGCS.CommStatusButtonView.prototype.setButton=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse ");var b="Link: None",c="btn-inverse";a===MineGCS.CommStatusModel.State.UNINITIALIZED?(c="btn-inverse",b="Link: None"):a===MineGCS.CommStatusModel.State.OK?(c="btn-success",b="Link: Good"):a===MineGCS.CommStatusModel.State.TIMED_OUT_ONCE?(c="btn-warning",b="Link: Lost"):a===MineGCS.CommStatusModel.State.TIMED_OUT_MANY?(c="btn-danger",b="Link: Lost"):(c="btn-danger",
...
goog.net.jsloader.Error=function(a,b){var c="Jsloader error (code #"+a+")";b&&(c+=": "+b);goog.debug.Error.call(this,c);this.code=a};goog.inherits(goog.net.jsloader.Error,goog.debug.Error);MineGCS.LeafletDroneIconModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.LeafletDroneIconModel,Backbone.Model);MineGCS.LeafletDroneIconModel.prototype.defaults=function(){return{icon:"predatorsmall"}};goog.exportSymbol("MineGCS.LeafletDroneIconModel.prototype.defaults",MineGCS.LeafletDroneIconModel.prototype.defaults);MineGCS.LeafletDroneIconModel.prototype.getIcon=function(){var a=this.get("icon");return new MineGCS.LeafletDroneIconModel.Icons[a].constructor};
MineGCS.LeafletDroneIconModel.Icons={predatorsmall:{description:"Predator (small)",constructor:L.Icon.extend({options:{iconUrl:"image/drone-tiny.png",shadowUrl:null,iconAnchor:new L.Point(37,25),iconSize:new L.Point(75,50)}})},predator:{description:"Predator",constructor:L.Icon.extend({options:{iconUrl:"image/drone-sm.png",shadowUrl:null,iconAnchor:new L.Point(75,50),iconSize:new L.Point(150,100)}})},arduplane:{description:"Generic Airplane",constructor:L.Icon.extend({options:{iconUrl:"image/plane.png",
shadowUrl:null,iconAnchor:new L.Point(36,38),iconSize:new L.Point(73,76)}})},quad:{description:"Quadcopter",constructor:L.Icon.extend({options:{iconUrl:"image/quad.png",shadowUrl:null,iconAnchor:new L.Point(37,37),iconSize:new L.Point(75,75)}})}};MineGCS.FlightModePopoverViewDelegate=function(a){this.popoverTitle="Flight Commands";Backbone.View.call(this,a)};goog.inherits(MineGCS.FlightModePopoverViewDelegate,Backbone.View);MineGCS.FlightModePopoverViewDelegate.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.commandModel=this.options.commandModel};goog.exportSymbol("MineGCS.FlightModePopoverViewDelegate.prototype.initialize",MineGCS.FlightModePopoverViewDelegate.prototype.initialize);
MineGCS.FlightModePopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.setupPopover()};MineGCS.FlightModePopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null;this.cleanupSubview("armingButtonView");this.cleanupSubview("loiterButtonView");this.cleanupSubview("rtlButtonView");this.cleanupSubview("landButtonView")};
MineGCS.FlightModePopoverViewDelegate.prototype.setupPopover=function(){this.$el.find(".popover-content").html('<p><a class="btn" id="flightmode-btn-arm" href="#">Arm</a></p><br /><a class="btn" id="flightmode-btn-loiter" href="#">Loiter</a><a class="btn" id="flightmode-btn-rtl" href="#">RTL</a><a class="btn" id="flightmode-btn-land" href="#">Land</a>');this.armingButtonView=new MineGCS.ArmingButtonView({el:$("#flightmode-btn-arm"),model:this.modeModel});this.loiterButtonView=new MineGCS.CommandButtonView({el:$("#flightmode-btn-loiter"),
model:this.commandModel,command:"NAV_LOITER_UNLIM"});this.rtlButtonView=new MineGCS.CommandButtonView({el:$("#flightmode-btn-rtl"),model:this.commandModel,command:"NAV_RETURN_TO_LAUNCH"});this.landButtonView=new MineGCS.CommandButtonView({el:$("#flightmode-btn-land"),model:this.commandModel,command:"NAV_LAND"})};MineGCS.FlightModePopoverViewDelegate.prototype.cleanupSubview=function(a){this[a]&&(this[a].remove(),this[a]=null)};MineGCS.AppRouter=function(a){this.pfdSettingsModel=a.pfdSettingsModel;this.routes={overview:"route_overview",fullpfd:"route_fullpfd",maponly:"route_maponly"};Backbone.Router.call(this,a)};goog.inherits(MineGCS.AppRouter,Backbone.Router);MineGCS.AppRouter.prototype.initialize=function(a){var b={};_.each(this.routes,function(a,d){var e=$("#navbar-"+d);0<e.length&&(b[d]=e)});this.navbar=b};goog.exportSymbol("MineGCS.AppRouter.prototype.initialize",MineGCS.AppRouter.prototype.initialize);
MineGCS.AppRouter.prototype.route_overview=function(){this.setnavbar("overview");this.pfdSettingsModel.set({size:MineGCS.PFDSettingsModel.Size.STANDARD})};goog.exportSymbol("MineGCS.AppRouter.prototype.route_overview",MineGCS.AppRouter.prototype.route_overview);MineGCS.AppRouter.prototype.route_fullpfd=function(){this.setnavbar("fullpfd");this.pfdSettingsModel.set({size:MineGCS.PFDSettingsModel.Size.FULLSCREEN})};goog.exportSymbol("MineGCS.AppRouter.prototype.route_fullpfd",MineGCS.AppRouter.prototype.route_fullpfd);
MineGCS.AppRouter.prototype.route_maponly=function(){this.setnavbar("maponly");this.pfdSettingsModel.set({size:MineGCS.PFDSettingsModel.Size.HIDDEN})};goog.exportSymbol("MineGCS.AppRouter.prototype.route_maponly",MineGCS.AppRouter.prototype.route_maponly);MineGCS.AppRouter.prototype.setnavbar=function(a){_.each(this.navbar,function(a){a.removeClass("active")});this.navbar[a].addClass("active")};MineGCS.ArtificialHorizon=function(a){this.initArtificialHorizon_(a);Kinetic.Shape.call(this,a)};goog.inherits(MineGCS.ArtificialHorizon,Kinetic.Shape);MineGCS.ArtificialHorizon.prototype.initArtificialHorizon_=function(a){Kinetic.Shape.call(this,a);this.setAttrs({width:100,height:100,skyColor:"#72cde4",groundColor:"#323232",lineColor:"#ffffff",planeColor:"black"});this.shapeType="ArtificialHorizon";this.radius=Math.min(a.width,a.height)/2;this.roll=this.pitch=0;this._setDrawFuncs()};
MineGCS.ArtificialHorizon.prototype.drawFunc=function(a){a=a.getContext();var b=this.getHorizon_(this.pitch),c=this.getAttrs(),d=c.width,e=c.height;a.translate(d/2,e/2);a.save();a.beginPath();a.rect(-d/2,-e/2,d,e);a.clip();a.rotate(-this.roll);a.fillStyle=c.groundColor;a.strokeStyle=c.lineColor;a.lineWidth=3;a.beginPath();a.rect(-d,b,2*d,e);a.fill();a.fillStyle=c.skyColor;a.beginPath();a.rect(-d,-e,2*d,e+b);a.fill();a.lineWidth=1;a.beginPath();a.moveTo(-d/2,b);a.lineTo(d/2,b);a.stroke();this.drawPitchRung_(a,
...
-1);a.lineTo(10,-1);a.lineTo(5,5);a.stroke()};goog.exportSymbol("MineGCS.ArtificialHorizon.prototype.drawFunc",MineGCS.ArtificialHorizon.prototype.drawFunc);
MineGCS.ArtificialHorizon.prototype.drawTriangle_=function(a,b,c,d,e){Math.cos(b);Math.sin(b);var f=2*Math.PI/180,g=this.getAttrs();a.lineWidth=1;a.strokeStyle=g.lineColor;a.beginPath();a.moveTo(d*Math.cos(b),d*Math.sin(b));a.lineTo((d+c)*Math.cos(b+f),(d+c)*Math.sin(b+f));a.lineTo((d+c)*Math.cos(b-f),(d+c)*Math.sin(b-f));a.lineTo(d*Math.cos(b),d*Math.sin(b));a.stroke();e&&(a.fillStyle=g.lineColor,a.fill())};
MineGCS.ArtificialHorizon.prototype.drawRollRung_=function(a,b,c,d){var e=Math.cos(b);b=Math.sin(b);var f=this.getAttrs();a.lineWidth=1;a.strokeStyle=f.lineColor;a.beginPath();a.moveTo(e*d,b*d);a.lineTo(e*(d+c),b*(d+c));a.stroke()};
MineGCS.ArtificialHorizon.prototype.drawPitchRung_=function(a,b,c){var d=this.getAttrs();a.lineWidth=1;a.strokeStyle=d.lineColor;d=this.getHorizon_(this.pitch+b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke();d=this.getHorizon_(this.pitch-b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke()};MineGCS.ArtificialHorizon.prototype.getHorizon_=function(a){return Math.sin(a)*this.radius};
MineGCS.ArtificialHorizon.prototype.setPitchRoll=function(a,b){this.pitch=a;this.roll=b};MineGCS.Tape=function(a){Kinetic.Shape.call(this,a);this.initTape_(a)};goog.inherits(MineGCS.Tape,Kinetic.Shape);MineGCS.Tape.WIDTH=30;MineGCS.Tape.HEIGHT=140;
MineGCS.Tape.prototype.initTape_=function(a){var b=MineGCS.Tape.WIDTH,c=MineGCS.Tape.HEIGHT;this.setAttrs({backgroundColor:void 0,width:b,height:c,fontFamily:"Calibri",fontSize:12,fontStyle:"normal",side:MineGCS.Tape.SideType.LEFT});this.value=0;this.targetValue=null;this.valueText="0";Kinetic.Shape.call(this,a);this._setDrawFuncs();this.instantaneousPolygon=new Kinetic.Polygon({points:this.reflect_([0,60*c/140,25*b/30,60*c/140,b,c/2,25*b/30,80*c/140,0,80*c/140,0,60*c/140]),stroke:a.fontColor,
strokeWidth:1,fill:a.instantaneousBackgroundColor});this.bug=new Kinetic.Polygon({x:0,y:0,points:this.reflect_([31*b/30,0,34*b/30,-2*c/140,36*b/30,-2*c/140,36*b/30,2*c/140,34*b/30,2*c/140,31*b/30,0]),stroke:a.bugColor,fill:a.bugColor,strokeWidth:1})};MineGCS.Tape.prototype.reflect1_=function(a){var b=this.getAttrs();return b.side===MineGCS.Tape.SideType.RIGHT?b.width-a:a};
MineGCS.Tape.prototype.reflect_=function(a){var b=this.getAttrs();if(b.side===MineGCS.Tape.SideType.RIGHT)for(var b=b.width,c=a.length,d=0;d<c;d+=2)a[d]=b-a[d];return a};MineGCS.Tape.prototype.setValue=function(a){if(a!=this.value){this.value=a;var b="ERR";goog.isDefAndNotNull(a)&&(b=a.toString());3<b.length&&(b=b.substring(0,3),"."==b.charAt(b.length-1)&&(b=b.substr(0,b.length-1)));this.valueText=b}};MineGCS.Tape.prototype.setTargetValue=function(a){this.targetValue=a};
MineGCS.Tape.prototype.drawFunc=function(a){var b=a.getContext(),c=MineGCS.Tape.WIDTH,d=MineGCS.Tape.HEIGHT,e=this.getAttrs();goog.isDefAndNotNull(e.backgroundColor)&&(b.beginPath(),b.fillStyle=e.backgroundColor,b.rect(0,0,30,140),b.closePath(),this.fillStroke(b));var f=this.value-d/4,f=2*Math.ceil(f/2),f=Math.max(0,f),g=this.value+d/4,g=2*Math.floor(g/2),h="normal "+0.9*e.fontSize+"pt "+e.fontFamily;b.font=h;b.fillStyle=e.fontColor;b.strokeStyle=e.fontColor;b.textBaseLine="top";b.textAlign=e.side===
...
new Kinetic.Text({x:0,y:5,width:30,align:"center",fontSize:c,fontFamily:this.options.fontFamily,textFill:this.options.bugColor});this.layer.add(this.targetSpeedDisplay)};MineGCS.PFD.prototype.setSize=function(a,b){var c,d=0;a/b>4/3?(c=4/3*b,d=b):(c=a,d=0.75*a);this.stage.setSize(c,d);this.stage.setScale(c/200,c/200)};MineGCS.PFD.prototype.setSpeed=function(a){this.speedTape.setValue(a)};
MineGCS.PFD.prototype.setTargetSpeed=function(a){this.targetSpeed=a;null===a?(this.speedTape.setTargetValue(null),this.targetSpeedDisplay.hide()):(this.speedTape.setTargetValue(a),this.targetSpeedDisplay.setText(Math.round(a).toString()),this.targetSpeedDisplay.show())};MineGCS.PFD.prototype.draw=function(){this.visible&&this.layer.draw()};MineGCS.PFD.prototype.setVisible=function(a){this.visible=a};MineGCS.PFD.prototype.setAltitude=function(a){this.altitudeTape.setValue(a)};
MineGCS.PFD.prototype.setTargetAltitude=function(a){this.targetAltitude=a;null===a?(this.altitudeTape.setTargetValue(null),this.targetAltitudeDisplay.hide()):(this.altitudeTape.setTargetValue(a),this.targetAltitudeDisplay.setText(Math.round(a).toString()),this.targetAltitudeDisplay.show())};MineGCS.PFD.setHeading=function(a){};MineGCS.PFD.prototype.setAttitude=function(a,b){this.attitudeIndicator.setPitchRoll(a,b)};goog.json={};goog.json.isValid_=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};goog.json.parse=function(a){a=String(a);if(goog.json.isValid_(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};goog.json.unsafeParse=function(a){return eval("("+a+")")};
...
goog.json.Serializer.prototype.serializeObject_=function(a,b){b.push("{");var c="",d;for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var e=a[d];"function"!=typeof e&&(b.push(c),this.serializeString_(d,b),b.push(":"),this.serialize_(this.replacer_?this.replacer_.call(a,d,e):e,b),c=",")}b.push("}")};MineGCS.PFDSettingsModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.PFDSettingsModel,Backbone.Model);MineGCS.PFDSettingsModel.Position={TOPLEFT:0,TOPRIGHT:1,BOTTOMLEFT:2,BOTTOMRIGHT:3};MineGCS.PFDSettingsModel.Size={STANDARD:0,FULLSCREEN:1,SMALL:2,HIDDEN:3};MineGCS.PFDSettingsModel.prototype.initialize=function(){this.bind("change",function(){this.writeToCookie()})};goog.exportSymbol("MineGCS.PFDSettingsModel.prototype.initialize",MineGCS.PFDSettingsModel.prototype.initialize);
MineGCS.PFDSettingsModel.prototype.defaults=function(){var a=this.readFromCookie();return a?{position:a.position||MineGCS.PFDSettingsModel.Position.TOPLEFT,size:a.size||MineGCS.PFDSettingsModel.Size.STANDARD}:{position:MineGCS.PFDSettingsModel.Position.TOPLEFT,size:MineGCS.PFDSettingsModel.Size.STANDARD}};goog.exportSymbol("MineGCS.PFDSettingsModel.prototype.defaults",MineGCS.PFDSettingsModel.prototype.defaults);
MineGCS.PFDSettingsModel.prototype.readFromCookie=function(){var a=$.cookie("pfdSettings");if(a){window.console.log("cookieData");window.console.log(a);try{return goog.json.parse(a)}catch(b){return window.console.warn("Unable to parse pfdSettings cookie data:"),window.console.warn(a),null}}else return null};MineGCS.PFDSettingsModel.prototype.writeToCookie=function(){var a=goog.json.serialize(this.toJSON());window.console.log("writeToCookie:");window.console.log(a);$.cookie("pfdSettings",a)};MineGCS.PFDView=function(a){this.pfd=null;this.settingToDimension={};Backbone.View.call(this,a)};goog.inherits(MineGCS.PFDView,Backbone.View);
MineGCS.PFDView.prototype.initialize=function(){this.blockel=this.options.blockel;this.statel=this.options.statel;this.pfdel=$("#"+this.options.drawingid);var a=this.options.mavlinkSrc;this.attitude=a.subscribe("ATTITUDE",this.onAttitudeChange,this);this.vfrHud=a.subscribe("VFR_HUD",this.onVfrHudChange,this);this.navControllerOutput=a.subscribe("NAV_CONTROLLER_OUTPUT",this.onNavControllerOutputChange,this);this.pfd=new MineGCS.PFD(this.options.drawingid);this.options.settingsModel&&(this.settingsModel=
this.options.settingsModel,this.settingToDimension[MineGCS.PFDSettingsModel.Size.STANDARD]={height:function(){return"280px"},width:function(){return"400px"}},this.settingToDimension[MineGCS.PFDSettingsModel.Size.FULLSCREEN]={height:function(){return $(window).height()-120},width:function(){return $(window).width()}},this.settingToDimension[MineGCS.PFDSettingsModel.Size.SMALL]={height:function(){return"140px"},width:function(){return"200px"}},this.settingsModel.bind("change",this.onSettingsChange,
this),this.onSettingsChange());this.onAttitudeChange();this.onVfrHudChange();this.onNavControllerOutputChange()};goog.exportSymbol("MineGCS.PFDView.prototype.initialize",MineGCS.PFDView.prototype.initialize);MineGCS.PFDView.prototype.onAttitudeChange=function(){this.pfd.setAttitude(this.attitude.get("pitch"),this.attitude.get("roll"));this.pfd.draw()};
MineGCS.PFDView.prototype.onVfrHudChange=function(){var a=this.vfrHud.get("alt");this.pfd.setAltitude(a);a=this.vfrHud.get("airspeed");this.pfd.setSpeed(a);this.pfd.draw()};MineGCS.PFDView.prototype.onNavControllerOutputChange=function(){var a=this.navControllerOutput.get("alt_error"),b=this.navControllerOutput.get("aspd_error");0<Math.abs(a)&&this.pfd.setTargetAltitude(this.vfrHud.get("alt")+a);0<Math.abs(b)&&this.pfd.setTargetSpeed(this.vfrHud.get("airspeed")+b)};
MineGCS.PFDView.prototype.onSettingsChange=function(){var a=this.settingsModel.toJSON();this.setPosition(a.position);this.setSize(a.size)};
MineGCS.PFDView.prototype.setPosition=function(a){this.blockel.removeClass("pfd-top pfd-bottom pfd-left pfd-right");switch(a){case MineGCS.PFDSettingsModel.Position.TOPLEFT:this.blockel.addClass("pfd-top pfd-left");break;case MineGCS.PFDSettingsModel.Position.TOPRIGHT:this.blockel.addClass("pfd-top pfd-right");break;case MineGCS.PFDSettingsModel.Position.BOTTOMLEFT:this.blockel.addClass("pfd-bottom pfd-left");break;case MineGCS.PFDSettingsModel.Position.BOTTOMRIGHT:this.blockel.addClass("pfd-bottom pfd-right")}};
MineGCS.PFDView.prototype.setSize=function(a){goog.asserts.assert(goog.object.containsValue(MineGCS.PFDSettingsModel.Size,a),"unknown PFD size value: "+a);var b=this.blockel;a==MineGCS.PFDSettingsModel.Size.FULLSCREEN?$("#droneicon").addClass("droneicon-hide"):$("#droneicon").hasClass("droneicon-hide")&&$("#droneicon").removeClass("droneicon-hide");a==MineGCS.PFDSettingsModel.Size.HIDDEN?(this.pfd.setVisible(!1),b.hide()):(b.is(":hidden")&&(this.pfd.setVisible(!0),b.show()),b=this.settingToDimension[a],
a=b.width(),b=b.height(),this.pfdel.width(a).height(b),this.blockel.width(a),this.statel.width(a),this.pfd.setSize(this.pfdel.width(),this.pfdel.height()))};MineGCS.GuideAltitudeView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.GuideAltitudeView,Backbone.View);MineGCS.GuideAltitudeView.prototype.initialize=function(){var a=this;this.input=this.options.input;this.submit=this.options.submit;this.text=this.options.text;this.model.bind("change",this.render,this);this.render();this.input.change(function(){a.model.set({alt:a.input.val()})});this.submit.click(function(){a.model.send()})};
goog.exportSymbol("MineGCS.GuideAltitudeView.prototype.initialize",MineGCS.GuideAltitudeView.prototype.initialize);MineGCS.GuideAltitudeView.prototype.render=function(){var a=this.model.toJSON();this.text.html(a.alt.toString()+" m");this.input.val(a.alt);return this};goog.exportSymbol("MineGCS.GuideAltitudeView.prototype.render",MineGCS.GuideAltitudeView.prototype.render);MineGCS.FakeVehicle=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.FakeVehicle,Backbone.Model);MineGCS.FakeVehicle.prototype.defaults=function(){return{lat:37.7751,lon:-122.419,alt:30,heading:90,pitch:0,roll:0,velocity:10,t:0}};MineGCS.FakeVehicle.prototype.initialize=function(){var a=Date.now();this.lastmessagetime=this.lastupdate=this.firstupdate=a};goog.exportSymbol("MineGCS.FakeVehicle.prototype.initialize",MineGCS.FakeVehicle.prototype.initialize);
MineGCS.FakeVehicle.prototype.update=function(){var a=Date.now(),b=(a-this.lastupdate)/1E3,c=(a-this.firstupdate)/1E3,d=MineGCS.FakeVehicle.nextposition(this,b),e=this.toJSON(),f=2*b*e.velocity*Math.sin(goog.math.toRadians(e.pitch)),b=4*b*e.velocity*Math.sin(goog.math.toRadians(e.roll));this.set({lat:d.lat,lon:d.lon,alt:e.alt+f,heading:e.heading+b,pitch:8*Math.sin(c),roll:5+15*Math.sin(c/2),t:c});this.lastupdate=a};
MineGCS.FakeVehicle.prototype.requestMessages=function(a){var b=Date.now(),c=200<b-this.lastmessagetime;c&&(this.lastmessagetime=b);var d=this.toJSON(),e={};_.each(a,function(a,b){if(b in MineGCS.FakeVehicle.fakeHandlers){var h=a.get("_index")||0;e[b]={index:c?h+1:h,msg:MineGCS.FakeVehicle.fakeHandlers[b](d)}}});return e};MineGCS.FakeVehicle.fakeAttitude=function(a){return{pitch:goog.math.toRadians(a.pitch),roll:goog.math.toRadians(a.roll)}};
MineGCS.FakeVehicle.fakeVfrHud=function(a){return{heading:a.heading,alt:a.alt,airspeed:a.velocity}};MineGCS.FakeVehicle.fakeNavControllerOutput=function(a){return{alt_error:30-a.alt,aspd_error:4-a.velocity}};MineGCS.FakeVehicle.fakeGpsRawInt=function(a){return{fix_type:3,lat:Math.round(1E7*a.lat),lon:Math.round(1E7*a.lon)}};MineGCS.FakeVehicle.fakeMetaWaypoint=function(a){return{}};MineGCS.FakeVehicle.fakeHeartbeat=function(a){return{type:2,base_mode:129,custom_mode:3}};
MineGCS.FakeVehicle.fakeMetaLinkquality=function(a){return{master_in:Math.floor(11*a.t),master_out:Math.floor(9*a.t),mav_loss:0}};MineGCS.FakeVehicle.fakeGpsStatus=function(a){return{satellites_visible:8}};MineGCS.FakeVehicle.fakeStatustext=function(a){return{text:"Offline mode"}};MineGCS.FakeVehicle.fakeSysStatus=function(a){return{}};
MineGCS.FakeVehicle.fakeHandlers={ATTITUDE:MineGCS.FakeVehicle.fakeAttitude,VFR_HUD:MineGCS.FakeVehicle.fakeVfrHud,NAV_CONTROLLER_OUTPUT:MineGCS.FakeVehicle.fakeNavControllerOutput,GPS_RAW_INT:MineGCS.FakeVehicle.fakeGpsRawInt,META_WAYPOINT:MineGCS.FakeVehicle.fakeMetaWaypoint,HEARTBEAT:MineGCS.FakeVehicle.fakeHeartbeat,META_LINKQUALITY:MineGCS.FakeVehicle.fakeMetaLinkquality,GPS_STATUS:MineGCS.FakeVehicle.fakeGpsStatus,STATUSTEXT:MineGCS.FakeVehicle.fakeStatustext,SYS_STATUS:MineGCS.FakeVehicle.fakeSysStatus};
MineGCS.FakeVehicle.nextposition=function(a,b){var c=goog.math.toRadians(a.get("lat")),d=goog.math.toRadians(a.get("lon")),e=goog.math.toRadians(a.get("heading")),f=a.get("velocity")*b/1E3,g=Math.asin(Math.sin(c)*Math.cos(f/6371)+Math.cos(c)*Math.sin(f/6371)*Math.cos(e)),e=Math.sin(e)*Math.sin(f/6371)*Math.cos(c),c=Math.cos(f/6371)-Math.sin(c)*Math.sin(g),d=d+Math.atan2(e,c),d=(d+Math.PI)%(2*Math.PI)-Math.PI;if(isNaN(g)||isNaN(d))throw Error("nope");return{lat:goog.math.toDegrees(g),lon:goog.math.toDegrees(d)}};goog.structs={};goog.structs.Collection=function(){};goog.structs.getCount=function(a){return"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if("function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
...
goog.debug.LogManager.createLogger_=function(a){var b=new goog.debug.Logger(a);if(goog.debug.Logger.ENABLE_HIERARCHY){var c=a.lastIndexOf("."),d=a.substr(0,c),c=a.substr(c+1),d=goog.debug.LogManager.getLogger(d);d.addChild_(c,b);b.setParent_(d)}return goog.debug.LogManager.loggers_[a]=b};MineGCS.MavlinkMessage=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.MavlinkMessage,Backbone.Model);MineGCS.MavlinkAPI=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.MavlinkAPI,Backbone.Model);MineGCS.MavlinkAPI.prototype.initialize=function(){this.logger_=goog.debug.Logger.getLogger("mavelous.MavlinkAPI");this.url=this.get("url");this.gotonline=!1;this.online=!0;this.failcount=0;this.messageModels={};this.fakevehicle=null};
goog.exportSymbol("MineGCS.MavlinkAPI.prototype.initialize",MineGCS.MavlinkAPI.prototype.initialize);MineGCS.MavlinkAPI.prototype.subscribe=function(a,b,c){this.messageModels[a]||(this.messageModels[a]=new MineGCS.MavlinkMessage({_type:a,_index:-1}));a=this.messageModels[a];a.bind("change",b,c);return a};MineGCS.MavlinkAPI.prototype.handleMessages_=function(a){this.trigger("gotServerResponse");_.each(a,this.handleMessage_,this)};
MineGCS.MavlinkAPI.prototype.handleMessage_=function(a,b){var c=this.messageModels[b],d=c.get("_index");if(void 0===d||a.index>d)c.set({_index:a.index},{silent:!0}),c.set(a.msg)};MineGCS.MavlinkAPI.prototype.update=function(){if(this.online)this.onlineUpdate();else this.offlineUpdate()};
MineGCS.MavlinkAPI.prototype.onlineUpdate=function(){$.ajax({context:this,type:"GET",cache:!1,url:this.url+_.keys(this.messageModels).join("+"),datatype:"json",success:function(a){this.gotonline=!0;this.handleMessages_(a)},error:function(){this.trigger("gotServerError");this.gotonline||(this.failcount++,5<this.failcount&&this.useOfflineMode())}})};
MineGCS.MavlinkAPI.prototype.offlineUpdate=function(){goog.asserts.assert(this.fakevehicle);this.fakevehicle.update();var a=this.fakevehicle.requestMessages(this.messageModels);this.handleMessages_(a)};MineGCS.MavlinkAPI.prototype.useOfflineMode=function(){this.online&&!this.gotonline&&(this.logger_.info("Switching to offline mode"),this.online=!1,this.fakevehicle=new MineGCS.FakeVehicle({lat:45.5233,lon:-122.667}))};MineGCS.FlightModeModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.FlightModeModel,Backbone.Model);MineGCS.FlightModeModel.prototype.defaults=function(){return{armed:!1,arming:!1,disarming:!1,modestring:"None"}};goog.exportSymbol("MineGCS.FlightModeModel.prototype.defaults",MineGCS.FlightModeModel.prototype.defaults);
MineGCS.FlightModeModel.prototype.initialize=function(){this.heartbeat=this.get("mavlinkSrc").subscribe("HEARTBEAT",this.onHeartbeat,this);this.on("change:armed",this.onChangeArmed,this)};goog.exportSymbol("MineGCS.FlightModeModel.prototype.initialize",MineGCS.FlightModeModel.prototype.initialize);MineGCS.FlightModeModel.prototype.onHeartbeat=function(){var a=MineGCS.util.heartbeat.modestring(this.heartbeat),b=MineGCS.util.heartbeat.armed(this.heartbeat);this.set({armed:b,modestring:a})};
MineGCS.FlightModeModel.prototype.onChangeArmed=function(){this.get("armed")?this.get("arming")&&this.set("arming",!1):this.get("disarming")&&this.set("disarming",!1)};MineGCS.FlightModeModel.prototype.requestArm=function(){this.postArmRequest_(!0);this.set("arming",!0)};MineGCS.FlightModeModel.prototype.requestDisarm=function(){this.postArmRequest_(!1);this.set("disarming",!0)};
MineGCS.FlightModeModel.prototype.postArmRequest_=function(a){$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:"COMPONENT_ARM_DISARM",component:"SYSTEM_CONTROL",setting:a?"ARM":"DISARM"})})};MineGCS.CommandLongModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.CommandLongModel,Backbone.Model);
MineGCS.CommandLongModel.prototype.post=function(a){"string"==typeof a?$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:a})}):$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize(a)})};MineGCS.ArmingButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.ArmingButtonView,Backbone.View);
MineGCS.ArmingButtonView.prototype.initialize=function(){this.model.on("change:armed change:arming change:disarming",this.onChange_,this);this.$el.click(goog.bind(this.onClick_,this));this.onChange_()};goog.exportSymbol("MineGCS.ArmingButtonView.prototype.initialize",MineGCS.ArmingButtonView.prototype.initialize);MineGCS.ArmingButtonView.prototype.onClick_=function(){this.model.get("armed")?this.model.requestDisarm():this.model.requestArm()};
MineGCS.ArmingButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.model.get("armed")?(this.model.get("disarming")?this.$el.html("Disarming..."):this.$el.html("Click to Disarm"),this.$el.addClass("btn-warning")):(this.model.get("arming")?this.$el.html("Arming..."):this.$el.html("Click to Arm"),this.$el.addClass("btn-success"))};MineGCS.CommandButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.CommandButtonView,Backbone.View);
MineGCS.CommandButtonView.prototype.initialize=function(){this.command=this.options.command;this.$el.click(goog.bind(this.onClick_,this))};goog.exportSymbol("MineGCS.CommandButtonView.prototype.initialize",MineGCS.CommandButtonView.prototype.initialize);MineGCS.CommandButtonView.prototype.onClick_=function(){this.model.post(this.command)};MineGCS.FlightModeButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.FlightModeButtonView,Backbone.View);
MineGCS.FlightModeButtonView.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.$el=this.options.el;this.modeModel.on("change",this.onChange_,this)};goog.exportSymbol("MineGCS.FlightModeButtonView.prototype.initialize",MineGCS.FlightModeButtonView.prototype.initialize);MineGCS.FlightModeButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.modeModel.get("armed")?this.$el.addClass("btn-success"):this.$el.addClass("btn-warning");this.$el.html(this.modeModel.get("modestring"))};MineGCS.SettingsView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.SettingsView,Backbone.View);
MineGCS.SettingsView.prototype.initialize=function(){var a=this;this.modalToggle=this.options.modalToggle;this.modal=this.options.modal;this.modalToggle.click(function(){a.modal.modal("toggle")});this.map=this.options.map;this.mapView=this.options.mapView;this.mapProviderModel=this.options.mapProviderModel;this.vehicleIconModel=this.options.vehicleIconModel;this.mapProviderPicker=this.options.mapProviderPicker;this.mapZoomSlider=this.options.mapZoomSlider;this.mapZoomValue=this.options.mapZoomValue;
...
goog.exportSymbol("MineGCS.SettingsView.prototype.initialize",MineGCS.SettingsView.prototype.initialize);MineGCS.SettingsView.prototype.setupMapProviderPicker=function(){var a=this;void 0!==this.mapProviderModel&&(_.each(MineGCS.LeafletProviders.Providers,function(b,c){a.mapProviderPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.mapProviderPicker.change(function(){var b=a.mapProviderPicker.val();a.mapProviderModel.set("provider",b)}))};
MineGCS.SettingsView.prototype.setupMapZoomSlider=function(){var a=this;void 0!==this.map&&(this.mapZoomSlider.change(function(){a.map.setZoom(a.mapZoomSlider.val())}),this.map.on("zoomend",this.onZoomChange,this))};MineGCS.SettingsView.prototype.setupMapPathPicker=function(){var a=this;void 0!==this.map&&this.mapPathPicker.change(function(){var b=a.mapPathPicker.val();a.mapView.setPathVisible(b)})};
MineGCS.SettingsView.prototype.setupVehicleIconPicker=function(){var a=this;void 0!==this.vehicleIconModel&&(_.each(MineGCS.LeafletDroneIconModel.Icons,function(b,c){a.vehicleIconPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.vehicleIconPicker.change(function(){var b=a.vehicleIconPicker.val();a.vehicleIconModel.set("icon",b)}))};MineGCS.SettingsView.prototype.onZoomChange=function(){this.mapZoomSlider.val(this.map.getZoom());this.mapZoomValue.html(this.map.getZoom().toString())};
MineGCS.SettingsView.prototype.setupPFDSettings=function(){var a=this;this.pfdPositionLeft.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.BOTTOMLEFT)});this.pfdPositionRight.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.TOPRIGHT):a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.BOTTOMRIGHT)});
this.pfdPositionUp.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.TOPRIGHT)});this.pfdPositionDown.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.BOTTOMLEFT):a.pfdSettingsModel.set("position",MineGCS.PFDSettingsModel.Position.BOTTOMRIGHT)});this.pfdSettingsModel.bind("change",
this.onPFDSettingsChange,this);this.onPFDSettingsChange()};
MineGCS.SettingsView.prototype.onPFDSettingsChange=function(){switch(this.pfdSettingsModel.get("position")){case MineGCS.PFDSettingsModel.Position.TOPLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionUp.button("toggle");break;case MineGCS.PFDSettingsModel.Position.TOPRIGHT:this.pfdPositionRight.button("toggle");this.pfdPositionUp.button("toggle");break;case MineGCS.PFDSettingsModel.Position.BOTTOMLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionDown.button("toggle");break;case MineGCS.PFDSettingsModel.Position.BOTTOMRIGHT:this.pfdPositionRight.button("toggle"),
this.pfdPositionDown.button("toggle")}};var markerIcon=L.Icon.extend({options:{iconUrl:"third_party/leaflet/images/marker-icon.png",shadowUrl:"third_party/leaflet/images/marker-shadow.png",iconAnchor:new L.Point(13,41),iconSize:new L.Point(25,41)}});L.Transition=null;MineGCS.UnanimatedMap=function(a,b){L.Map.call(this,a,b)};goog.inherits(MineGCS.UnanimatedMap,L.Map);
MineGCS.UnanimatedMap.prototype.panTo=function(a){a=this._getNewTopLeftPoint(a).subtract(this._getTopLeftPoint());this.fire("movestart");this._rawPanBy(a);this.fire("move");this.fire("moveend")};MineGCS.LeafletView=function(a){Backbone.View.call(this,a)};goog.inherits(MineGCS.LeafletView,Backbone.View);
MineGCS.LeafletView.prototype.initialize=function(){this.vehicleModel=this.options.vehicle;this.vehicleIconModel=this.options.vehicleIcon;this.providerModel=this.options.provider;this.guideModel=this.options.guideModel;this.panModel=this.options.panModel;this.initializedcenter=!1;this.vehiclePathVisible=!0;this.tileLayer=this.providerModel.getProvider();this.touchzoomable=L.Browser.touch&&!L.Browser.android23;this.map=new MineGCS.UnanimatedMap("map",{layers:[this.tileLayer],zoomControl:!1,doubleClickZoom:!1,
...
this);this.vehicleModel.bind("change",this.updateVehiclePath,this);this.map.addEventListener("dblclick",this.doubleClickHandler,this);this.guideModel.bind("change",this.updateGuideMarker,this)};goog.exportSymbol("MineGCS.LeafletView.prototype.initialize",MineGCS.LeafletView.prototype.initialize);MineGCS.LeafletView.prototype.doubleClickHandler=function(a){this.guideModel.setTarget({lat:a.latlng.lat,lon:a.latlng.lng})};
MineGCS.LeafletView.prototype.providerChange=function(){this.map.removeLayer(this.tileLayer);this.tileLayer=this.providerModel.getProvider();this.map.addLayer(this.tileLayer)};MineGCS.LeafletView.prototype.panModelChange=function(){var a=this.panModel.get("center");void 0!==a&&(this.initializedcenter?this.map.panTo(a):(this.map.setView(a,16),this.initializedcenter=!0))};
MineGCS.LeafletView.prototype.panTrackingChange=function(){var a=this.panModel.get("tracking");void 0!==a&&(a?(this.map.scrollWheelZoom.disable(),this.map.centerScrollWheelZoom.enable(),this.map.touchZoom.disable(),this.touchzoomable&&this.map.centerTouchZoom.enable()):(this.map.scrollWheelZoom.enable(),this.map.centerScrollWheelZoom.disable(),this.map.centerTouchZoom.disable(),this.touchzoomable&&this.map.touchZoom.enable()))};
MineGCS.LeafletView.prototype.updateVehicleMarker=function(){if(this.initializedcenter){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(void 0===this.vehicleMarker?(this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker)):(this.vehicleMarker.setLatLng(a),this.vehicleMarker.setIconAngle(b)))}};
MineGCS.LeafletView.prototype.vehicleIconChange=function(){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(this.map.removeLayer(this.vehicleMarker),this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker))};
MineGCS.LeafletView.prototype.setPathVisible=function(a){void 0===this.vehiclePathVisible&&(this.vehiclePathVisible=!0);"on"==a&&(this.vehiclePathVisible=!0);"off"==a&&(this.vehiclePathVisible=!1,this.map.removeLayer(this.vehiclePath),this.vehiclePath=void 0)};
MineGCS.LeafletView.prototype.updateVehiclePath=function(){var a=this.vehicleModel.get("position");a&&!1!=this.vehiclePathVisible&&(void 0===this.vehiclePath?(this.vehiclePath=new L.Polyline([a],{color:"red"}),this.vehiclePath.addTo(this.map)):this.vehiclePath.addLatLng(a))};
MineGCS.LeafletView.prototype.updateGuideMarker=function(){var a=this.guideModel.toJSON(),b=new L.LatLng(a.lat,a.lon);a&&(void 0===this.guideMarker?(this.guideMarker=new L.Marker(b,{icon:new markerIcon}),this.map.addLayer(this.guideMarker)):this.guideMarker.setLatLng(b))};MineGCS.VehicleLeafletPosition=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.VehicleLeafletPosition,Backbone.Model);MineGCS.VehicleLeafletPosition.prototype.defaults=function(){return{position:null,heading:0}};goog.exportSymbol("MineGCS.VehicleLeafletPosition.prototype.defaults",MineGCS.VehicleLeafletPosition.prototype.defaults);
MineGCS.VehicleLeafletPosition.prototype.initialize=function(){var a=this.get("mavlinkSrc");this.vehicleGps=a.subscribe("GPS_RAW_INT",this.withVehicleGps,this);this.vehicleHead=a.subscribe("VFR_HUD",this.withVehicleHead,this)};goog.exportSymbol("MineGCS.VehicleLeafletPosition.prototype.initialize",MineGCS.VehicleLeafletPosition.prototype.initialize);
MineGCS.VehicleLeafletPosition.prototype.withVehicleGps=function(){var a=this.vehicleGps.toJSON();0===a.lat&&0===a.lon||this.set("position",new L.LatLng(a.lat/1E7,a.lon/1E7))};MineGCS.VehicleLeafletPosition.prototype.withVehicleHead=function(){var a=this.vehicleHead.get("heading");this.set("heading",a)};MineGCS.GuideModel=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.GuideModel,Backbone.Model);MineGCS.GuideModel.prototype.defaults=function(){return{alt:20,lat:null,lon:null}};goog.exportSymbol("MineGCS.GuideModel.prototype.defaults",MineGCS.GuideModel.prototype.defaults);MineGCS.GuideModel.prototype.initialize=function(){this.metaWaypointModel=this.get("mavlinkSrc").subscribe("META_WAYPOINT",this.onMetaWaypointChange,this)};
goog.exportSymbol("MineGCS.GuideModel.prototype.initialize",MineGCS.GuideModel.prototype.initialize);MineGCS.GuideModel.prototype.onMetaWaypointChange=function(){var a=this.metaWaypointModel.get("waypoint");a&&this.set({alt:a.alt,lat:a.lat,lon:a.lon})};MineGCS.GuideModel.prototype.setTarget=function(a){this.set(a);this.send()};MineGCS.GuideModel.prototype.send=function(){var a={lat:this.get("lat"),lon:this.get("lon"),alt:this.get("alt")};null!==a.lat&&(null!==a.lon&&null!==a.alt)&&this.sendServer(a)};
MineGCS.GuideModel.prototype.sendServer=function(a){a=goog.json.serialize({command:"FLYTO",location:a});$.ajax({type:"POST",url:"/guide",data:a})};MineGCS.LeafletProviders=function(a){Backbone.Model.call(this,a)};goog.inherits(MineGCS.LeafletProviders,Backbone.Model);MineGCS.LeafletProviders.bingKey="AnFxXUB376BgaEQMj947c43V45ipmMvdcoY-TAE4-Y23mu1yFLHF0k2BMJP-MU1B";MineGCS.LeafletProviders.prototype.defaults=function(){return{provider:"bing"}};goog.exportSymbol("MineGCS.LeafletProviders.prototype.defaults",MineGCS.LeafletProviders.prototype.defaults);
MineGCS.LeafletProviders.prototype.getProvider=function(){var a=this.get("provider");return MineGCS.LeafletProviders.Providers[a].constructor()};
MineGCS.LeafletProviders.Providers={bing:{description:"Bing Satellite with Labels",constructor:function(){return new L.BingLayer(MineGCS.LeafletProviders.bingKey,{type:"AerialWithLabels",maxZoom:21})}},cloudmade:{description:"Cloudmade Road Map",constructor:function(){return new L.TileLayer("http://{s}.tile.cloudmade.com/420c27bae8514670a02a1684e8398d33/997/256/{z}/{x}/{y}.png",{maxZoom:18})}},osm:{description:"OpenStreetMaps",constructor:function(){return new L.TileLayer("http://{s}.tile.openstreetmap.org//{z}/{x}/{y}.png",
...
goog.debug.Console.show=function(){alert(goog.debug.Console.instance.logBuffer_)};goog.debug.Console.logToConsole_=function(a,b,c){if(a[b])a[b](c);else a.log(c)};MineGCS.App=function(){};
MineGCS.App.prototype.start=function(){(new goog.debug.Console).setCapturing(!0);var a=new goog.Uri(window.location.href);this.mavlinkAPI=new MineGCS.MavlinkAPI({url:"/mavlink/"});goog.isDef(a.getParameterValue("offline"))&&this.mavlinkAPI.useOfflineMode();a=a.getParameterValue("debug");if(goog.isDef(a)){window.console.log("Enabling debug mode");var b=document.getElementById("fps"),c=goog.dom.createDom("span",{id:"fpsvalue"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,goog.dom.createTextNode(" fps"));
(new goog.debug.FpsDisplay).decorate(c);0<a.length&&(window.console.log("Enabling phonegap at http://debug.phonegap.com/client/#"+a),goog.net.jsloader.load("http://debug.phonegap.com/target/target-script-min.js#"+a))}this.pfdSettingsModel=new MineGCS.PFDSettingsModel;this.pfdView=new MineGCS.PFDView({mavlinkSrc:this.mavlinkAPI,settingsModel:this.pfdSettingsModel,drawingid:"pfdview",blockel:$("#pfdblock"),statel:$("#pfdstatus")});this.guideModel=new MineGCS.GuideModel({mavlinkSrc:this.mavlinkAPI});
this.guideAltView=new MineGCS.GuideAltitudeView({model:this.guideModel,input:$("#guidealt-input"),submit:$("#guidealt-submit"),text:$("#guidealt-text")});this.leafletDroneIcon=new MineGCS.LeafletDroneIconModel;this.leafletProviders=new MineGCS.LeafletProviders;this.vehicle=new MineGCS.VehicleLeafletPosition({mavlinkSrc:this.mavlinkAPI});this.panModel=new MineGCS.LeafletPanModel({vehicle:this.vehicle});this.panCtrl=new MineGCS.LeafletPanControlView({model:this.panModel,button:$("#mapoverlay-btn-centermap"),
icon:$("#mapoverlay-icon-centermap")});this.mapView=new MineGCS.LeafletView({vehicle:this.vehicle,provider:this.leafletProviders,vehicleIcon:this.leafletDroneIcon,guideModel:this.guideModel,panModel:this.panModel});this.commStatusModel=new MineGCS.CommStatusModel({mavlinkSrc:this.mavlinkAPI});this.packetLossModel=new MineGCS.PacketLossModel({mavlinkSrc:this.mavlinkAPI});this.commStatusButtonView=new MineGCS.CommStatusButtonView({commStatusModel:this.commStatusModel,packetLossModel:this.packetLossModel,
el:$("#navbar-btn-link")});this.gpsButtonView=new MineGCS.GpsButtonView({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-gps")});this.statustextView=new MineGCS.StatustextView({mavlinkSrc:this.mavlinkAPI});this.modeStringView=new MineGCS.ModeStringView({mavlinkSrc:this.mavlinkAPI,el:$("#pfd_modestringview")});this.flightModeModel=new MineGCS.FlightModeModel({mavlinkSrc:this.mavlinkAPI});this.flightCommandModel=new MineGCS.CommandLongModel({mavlinkSrc:this.mavlinkAPI});this.flightModeButtonView=
new MineGCS.FlightModeButtonView({el:$("#navbar-btn-mode"),modeModel:this.flightModeModel});this.statusButtons=new MineGCS.RadioButtonPopoverView({popovers:[{btn:this.gpsButtonView,delegate:new MineGCS.GpsPopoverViewDelegate({mavlinkSrc:this.mavlinkAPI})},{btn:this.commStatusButtonView,delegate:new MineGCS.CommStatusPopoverViewDelegate({packetLossModel:this.packetLossModel})},{btn:this.flightModeButtonView,delegate:new MineGCS.FlightModePopoverViewDelegate({modeModel:this.flightModeModel,commandModel:this.flightCommandModel})}]});
this.batteryButton=new MineGCS.BatteryButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-battery")});this.settingsView=new MineGCS.SettingsView({map:this.mapView.map,mapView:this.mapView,mapProviderModel:this.leafletProviders,vehicleIconModel:this.leafletDroneIcon,modalToggle:$("#navbar-a-settings"),modal:$("#settings-modal"),mapProviderPicker:$("#settings-mapproviderpicker"),mapZoomSlider:$("#settings-mapzoom"),mapZoomValue:$("#settings-mapzoom-value"),mapPathPicker:$("#settings-mappathpicker"),
vehicleIconPicker:$("#settings-vehicleiconpicker"),pfdSettingsModel:this.pfdSettingsModel,pfdPositionLeft:$("#settings-pfdpos-left"),pfdPositionRight:$("#settings-pfdpos-right"),pfdPositionUp:$("#settings-pfdpos-up"),pfdPositionDown:$("#settings-pfdpos-down")});this.router=new MineGCS.AppRouter({pfdSettingsModel:this.pfdSettingsModel});Backbone.history.start();767<$(window).width()?this.router.navigate("overview",{trigger:!0}):this.router.navigate("maponly",{trigger:!0});var d=null,e=new goog.async.Throttle(function(){this.mavlinkAPI.update();
d.start()},100,this),d=new goog.async.AnimationDelay(function(){e.fire()});d.start()};goog.exportSymbol("MineGCS.App",MineGCS.App);goog.exportSymbol("MineGCS.App.prototype.start",MineGCS.App.prototype.start);
